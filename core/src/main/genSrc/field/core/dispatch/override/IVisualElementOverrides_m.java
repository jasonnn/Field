...
public class IVisualElementOverrides_m {
  public static final Method added_m = ReflectionTools.methodOf("added",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class);
  public static final Method beginExecution_m = ReflectionTools.methodOf("beginExecution",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class);
  public static final Method deleted_m = ReflectionTools.methodOf("deleted",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class);
  public static final Method deleteProperty_m = ReflectionTools.methodOf("deleteProperty",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class, VisualElementProperty.class);
  public static final Method endExecution_m = ReflectionTools.methodOf("endExecution",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class);
  public static final Method getProperty_m = ReflectionTools.methodOf("getProperty",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class, VisualElementProperty.class, Ref.class);
  public static final Method handleKeyboardEvent_m = ReflectionTools.methodOf("handleKeyboardEvent",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class, org.eclipse.swt.widgets.Event.class);
  public static final Method inspectablePropertiesFor_m = ReflectionTools.methodOf("inspectablePropertiesFor",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class, java.util.List.class);
  public static final Method isHit_m = ReflectionTools.methodOf("isHit",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class, org.eclipse.swt.widgets.Event.class, Ref.class);
  public static final Method menuItemsFor_m = ReflectionTools.methodOf("menuItemsFor",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class, java.util.Map.class);
  public static final Method paintNow_m = ReflectionTools.methodOf("paintNow",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class, Rect.class, boolean.class);
  public static final Method prepareForSave_m = ReflectionTools.methodOf("prepareForSave",IVisualElementOverrides.class);
  public static final Method setProperty_m = ReflectionTools.methodOf("setProperty",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class, VisualElementProperty.class, Ref.class);
  public static final Method shouldChangeFrame_m = ReflectionTools.methodOf("shouldChangeFrame",IVisualElementOverrides.class, field.core.dispatch.IVisualElement.class, Rect.class, Rect.class, boolean.class);
  // --------------------------------------------------------------------------------
  public static final MirrorMethod<IVisualElementOverrides,IVisualElement,TraversalHint> added_s = new MirrorMethod<IVisualElementOverrides,field.core.dispatch.IVisualElement,field.math.graph.visitors.hint.TraversalHint>(added_m);
  public static final MirrorMethod<IVisualElementOverrides,IVisualElement,TraversalHint> beginExecution_s = new MirrorMethod<IVisualElementOverrides,field.core.dispatch.IVisualElement,field.math.graph.visitors.hint.TraversalHint>(beginExecution_m);
  public static final MirrorMethod<IVisualElementOverrides,IVisualElement,TraversalHint> deleted_s = new MirrorMethod<IVisualElementOverrides,field.core.dispatch.IVisualElement,field.math.graph.visitors.hint.TraversalHint>(deleted_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> deleteProperty_s = new MirrorMethod<IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(deleteProperty_m);
  public static final MirrorMethod<IVisualElementOverrides,IVisualElement,TraversalHint> endExecution_s = new MirrorMethod<IVisualElementOverrides,field.core.dispatch.IVisualElement,field.math.graph.visitors.hint.TraversalHint>(endExecution_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> getProperty_s = new MirrorMethod<IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(getProperty_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> handleKeyboardEvent_s = new MirrorMethod<IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(handleKeyboardEvent_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> inspectablePropertiesFor_s = new MirrorMethod<IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(inspectablePropertiesFor_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> isHit_s = new MirrorMethod<IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(isHit_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> menuItemsFor_s = new MirrorMethod<IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(menuItemsFor_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> paintNow_s = new MirrorMethod<IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(paintNow_m);
  public static final MirrorMethod<IVisualElementOverrides,Void,TraversalHint> prepareForSave_s = new MirrorMethod<IVisualElementOverrides,Void,field.math.graph.visitors.hint.TraversalHint>(prepareForSave_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> setProperty_s = new MirrorMethod<IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(setProperty_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> shouldChangeFrame_s = new MirrorMethod<IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(shouldChangeFrame_m);
  // --------------------------------------------------------------------------------
