...
import field.core.dispatch.IVisualElementOverrides.Adaptor;
...
public class IVisualElementOverrides_m {
  ...
  // --------------------------------------------------------------------------------
  public static final MirrorMethod<IVisualElementOverrides,IVisualElement,TraversalHint> added_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,field.core.dispatch.IVisualElement,field.math.graph.visitors.hint.TraversalHint>(added_m);
  public static final MirrorMethod<IVisualElementOverrides,IVisualElement,TraversalHint> beginExecution_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,field.core.dispatch.IVisualElement,field.math.graph.visitors.hint.TraversalHint>(beginExecution_m);
  public static final MirrorMethod<IVisualElementOverrides,IVisualElement,TraversalHint> deleted_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,field.core.dispatch.IVisualElement,field.math.graph.visitors.hint.TraversalHint>(deleted_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> deleteProperty_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(deleteProperty_m);
  public static final MirrorMethod<IVisualElementOverrides,IVisualElement,TraversalHint> endExecution_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,field.core.dispatch.IVisualElement,field.math.graph.visitors.hint.TraversalHint>(endExecution_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> getProperty_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(getProperty_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> handleKeyboardEvent_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(handleKeyboardEvent_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> inspectablePropertiesFor_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(inspectablePropertiesFor_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> isHit_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(isHit_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> menuItemsFor_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(menuItemsFor_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> paintNow_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(paintNow_m);
  public static final MirrorMethod<IVisualElementOverrides,Void,TraversalHint> prepareForSave_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,Void,field.math.graph.visitors.hint.TraversalHint>(prepareForSave_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> setProperty_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(setProperty_m);
  public static final MirrorMethod<IVisualElementOverrides,Object[],TraversalHint> shouldChangeFrame_s = new MirrorMethod<field.core.dispatch.IVisualElementOverrides,Object[],field.math.graph.visitors.hint.TraversalHint>(shouldChangeFrame_m);
  // --------------------------------------------------------------------------------
