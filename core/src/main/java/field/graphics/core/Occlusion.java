...
class Occlusion {
    ...
    class Histogram {
        ...
        public
        Histogram(FullScreenCanvasSWT surface,
                  final float[] bins,
                  final int updateNum,
                  BasicTextures.BaseTexture source,
                  int width,
                  int height) {
            this.bins = bins;
            this.source = source;
    ...
    class AsynchronousQuery extends BasicUtilities.TwoPassElement implements IFloatProvider {
        ...
        public
        AsynchronousQuery setNeverSkip(boolean neverSkip) {
