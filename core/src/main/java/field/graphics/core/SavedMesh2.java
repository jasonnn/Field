...
class SavedMesh2 {
    ...
    void save(ILongGeometry mesh, String name) throws IOException {
        ...
        else if (mesh instanceof TriangleMesh_long) b.addGeometry(((TriangleMesh_long) mesh));
        b.close();
    }
    ...
    public static
    TriangleMesh_long loadTriangle(String filename, Class<? extends TriangleMesh_long> meshClass)
    ...
    public static
    PointList loadPoint(String filename, Class<? extends PointList> meshClass)
            throws IOException, InstantiationException, IllegalAccessException {
        Header header = (Header) PythonUtils.loadAsXML(filename + ".xmlHeader");
