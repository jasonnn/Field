...
class SaverOnscreen {
    ...
    public
    SaverOnscreen(int width, int height, int numWorkers, String prefix) {
        this.width = width;
        this.height = height;
    ...
    private
    void getImage(ByteBuffer storage) {
...
//		glFinish();
    ...
    private
    Callable<ByteBuffer> makeWorker(final ByteBuffer storage, final String filename) {
        return new Callable<ByteBuffer>() {
            public
            ByteBuffer call() throws Exception {
