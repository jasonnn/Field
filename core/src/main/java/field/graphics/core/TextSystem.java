...
class TextSystem {
    ...
    class AribitraryComponent {
        ...
        public
        AribitraryComponent(int w, int h) {
            this.w = w;
            this.h = h;
            ...
            slow = (BaseFastRawTexture) new AdvancedTextures.BaseFastRawTexture("",
                                                                                intBuffer,
                                                                                w,
                                                                                h,
                                                                                null).use_gl_texture_rectangle_ext(true);
        }
        ...
        public
        void drawIntoMesh(iDynamicMesh triangle, float r, float g, float b, float a, float ox, float by) {
            triangle.open();
        ...
        public
        void drawIntoMeshXFlipped(iDynamicMesh triangle, float r, float g, float b, float a, float ox, float by) {
            triangle.open();
        ...
        public
        void resetImage(JComponent componentToRender, float backr, float backg, float backb, float backa) {
    ...
    public
    class RectangularLabel implements iLabel {
        ...
        RectangularLabel(int w, int h) {
            ...
            slow = (BaseFastRawTexture) new AdvancedTextures.BaseFastRawTexture("",
                                                                                ...
                                                                                w,
                                                                                h,
                                                                                null).use_gl_texture_rectangle_ext(false);
        ...
        public
        RectangularLabel(String text, Font font, float rotation) {
            ...
            BufferedImage imageTmp =
                    dev.getDefaultConfiguration().createCompatibleImage(1, 1, Transparency.TRANSLUCENT);
            ...
            if (bounds.getHeight() < font.getSize() * 3.5f) {
                bounds.setFrame(new Rectangle2D.Double(bounds.getX(),
                                                       bounds.getY(),
                                                       bounds.getWidth(),
                                                       font.getSize() * 3.5f));
            }
            ...
            slow = (BaseFastRawTexture) new AdvancedTextures.BaseFastRawTexture(text,
                                                                                intBuffer,
                                                                                w,
                                                                                h,
                                                                                null).use_gl_texture_rectangle_ext(true);
        ...
        public
        void drawIntoMeshRotated(iDynamicMesh triangle,
                                 float r,
                                 float g,
                                 float b,
                                 float a,
        ...
        public
        void drawIntoMeshAll(iDynamicMesh triangle, float r, float g, float b, float a, float ox, float by) {
            triangle.open();
        ...
        public
        void drawIntoMeshScaled(iDynamicMesh triangle,
                                float r,
                                float g,
                                float b,
                                float a,
            ...
            Vector3 xx3 =
                    new Vector3(AX + x + hw * totalScale, AY + y + hh * totalScale + (int) (descent / scaling), z);
        ...
        public
        void drawIntoMeshScaledRotated(iDynamicMesh triangle,
                                       float r,
                                       float g,
                                       float b,
                                       float a,
            ...
            int v0 = triangle.nextVertex(xx1);
            Vector3 xx2 = q.rotateVector(new Vector3(AX + hw * totalScale, AY, 0))
                           .add(new Vector3(x, y + (int) (descent / scaling), z));
            int v1 = triangle.nextVertex(xx2);
            Vector3 xx3 = q.rotateVector(new Vector3(AX + hw * totalScale, AY + hh * totalScale, 0))
                           .add(new Vector3(x, y + (int) (descent / scaling), z));
            int v2 = triangle.nextVertex(xx3);
            Vector3 xx4 = q.rotateVector(new Vector3(AX, AY + hh * totalScale, 0))
                           .add(new Vector3(x, y + (int) (descent / scaling), z));
            int v3 = triangle.nextVertex(xx4);
...
//			;//System.out.println(" label on ---------");
        ...
        public
        void resetTextAsLabel(String text,
                              float backr,
                              float backg,
                              float backb,
                              float backa,
            ...
            stringBounds.setRect(stringBounds.getX(),
                                 stringBounds.getY(),
            ...
            view.paint(g2,
                       new Rectangle(0,
                                     (int) (30 * rotation / (Math.PI / 2) + (int) (-offset / 2)),
                                     Math.max(w, h),
                                     Math.max(w, h)));
        ...
        public
        void resetTextAsLabelWithMaxSize(String text,
                                         float backr,
                                         float backg,
                                         float backb,
                                         float backa,
            ...
            if ((int) (width * 1.2f) != w || view.getPreferredSpan(View.Y_AXIS) != h) {
                ...
                intBuffer.put(data);
                intBuffer.rewind();
                if (slow != null) slow.deallocate(atRenderTime);
        ...
        public
        void resetTextDropShadow(String text,
                                 float backr,
                                 float backg,
                                 float backb,
                                 float backa,
            ...
            try {
                ...
                PlanarImage dst = JAI.create("convolve",
                                             image,
                                             new KernelJAI(3,
                                                           3,
                                                           new float[]{a / 2,
        ...
        public
        void setFont(Font f) {
            if (scaling != 1) f = f.deriveFont(f.getSize() * scaling);
            this.font = f;
            g2.setFont(f);
    ...
    public
    void beginRender(Object gl, Object glu) {
        this.gl = gl;
        this.glu = glu;
    }
