...
public
class LayeredStereoCamera extends BasicCamera {
    ...
    public
    LayeredStereoCamera setIOFrustra(float i) {
        this.io_frustra = i;
        return this;
    }

    public
    LayeredStereoCamera setIOPosition(Vector3 v) {
        this.io_position = new Vector3(v);
        return this;
    }

    public
    LayeredStereoCamera setIOPosition(float m) {
        this.io_position = new Vector3(m, m, m);
        return this;
    }

    public
    LayeredStereoCamera setIOLookAt(float x) {
        this.io_lookat = x;
        return this;
    }
    ...
    void performPass() {
...

        {
            ...
            CoreHelpers.gluLookAt(position.x + (flipped * (io_position.x) * x * left.x),
                                  ...
                                  lookAt.z + (flipped * io_lookat * x * left.z),
                                  up.x,
                                  up.y,
                                  up.z);
