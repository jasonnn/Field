...
class BasicUtilities {
    ...
    class Clear extends OnePassElement implements iSceneListElement {
        ...
        void performPass() {
            ...
            if (FullScreenCanvasSWT.currentCanvas == null || (!FullScreenCanvasSWT.currentCanvas.passiveStereo
                                                              || FullScreenCanvasSWT.getSide() == StereoSide.right)) {
    ...
    class NoMeshSmoothing extends TwoPassElement {
        ...
        protected
        void post() {
            if (b) glEnable(GL_POLYGON_SMOOTH);
        }
    ...
    class PolygonOffset extends TwoPassElement {
        ...
        void post() {
            ...
            if (doLine) glDisable(GL_POLYGON_OFFSET_LINE);
        }
        ...
        void pre() {
            ...
            if (doLine) glEnable(GL_POLYGON_OFFSET_LINE);
        }
    ...
    class SetBlendMode extends OnePassElement {
        ...
        void performPass() {
            ...
            if (constant != null) glBlendColor(constant.x, constant.y, constant.z, constant.w);
    ...
    static public
    class SetColorMask extends TwoPassElement {
        private boolean b;
        ...
        public
        SetColorMask(boolean red, boolean green, boolean blue, boolean alpha) {
    ...
    static public
    class Smooth extends OnePassElement {
    ...
    class TwoPassElement extends BasicSceneList implements iSceneListElement {
        ...
        public
        TwoPassElement(String name, Base.StandardPass prePass, Base.StandardPass postPass) {
