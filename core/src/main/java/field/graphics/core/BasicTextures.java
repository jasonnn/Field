...
class BasicTextures {
    ...
    class BaseTexture extends BasicUtilities.TwoPassElement implements iSceneListElement {
         ...
         */
        public
        BaseTexture gl_texture_env_mode(int arg) {
         ...
         */
        public
        BaseTexture gl_texture_mag_filter(int arg) {
         ...
         */
        public
        BaseTexture gl_texture_min_filter(int arg) {
         ...
         */
        public
        BaseTexture gl_texture_wrap_s(int arg) {
         ...
         */
        public
        BaseTexture gl_texture_wrap_t(int arg) {
         ...
         */
        public
        BaseTexture use_gl_texture_rectangle_ext(boolean useRectangularTexture) {
            if (useRectangularTexture) textureTarget = GL_TEXTURE_RECTANGLE;
            else textureTarget = GL_TEXTURE_2D;
            return this;
        }
    ...
    class TextureFromQTImage extends BaseTexture implements iSceneListElement {
        ...
        public
        TextureFromQTImage(String name) {
            super(name);
            textureName = name;
        ...
        void refresh() {
            glTexSubImage2D(textureTarget,
                            ...
                            image.getImage());
            if (doGenMip) glGenerateMipmap(GL_TEXTURE_2D);
        }
        ...
        public
        void setImage(ByteImage im) {
            if (im != image) dirty = true;
            image = im;
        }

        public
        TextureFromQTImage setOnCard(boolean on) {
            this.onCard = on;
            return this;
        }
    ...
    class ExplicitMipTexture extends BaseTexture implements iSceneListElement {
        ...
        public
        ExplicitMipTexture(String... name) {
            super(name[0]);
    ...
    class TextureFromImage extends TextureFromQTImage {
        ...
        public
        TextureFromImage(ByteImage image) {
            super(image);
        }


        public
        TextureFromImage(String name) {
            super(name);
        }

        public
        TextureFromImage(URL resource) {
            super(resource);
        }

        public
        TextureFromImage rectangle() {
            use_gl_texture_rectangle_ext(true);
            return this;
        }

        public
        TextureFromImage square() {
            use_gl_texture_rectangle_ext(false);
            return this;
        }
    }
    ...
    class TextureUnit extends BaseTexture {
        ...
        public
        TextureUnit(int unit, TwoPassElement wrap) {
            this.unit = unit;
            this.wrap = wrap;
            assert wrap != null;
        }
        ...
        public
        TwoPassElement getWrapped() {
            return wrap;
        }
    }

    static public
    class StereoUnit extends BaseTexture {
        private final int unit;
        ...
        public
        StereoUnit(int unit, TwoPassElement left, TwoPassElement right) {
            this.unit = unit;
            this.left = left;
            this.right = right;
        ...
        void post() {
            ...
            TwoPassElement left;
            if (FullScreenCanvasSWT.getSide().x < 0) left = this.left;
            else left = this.right;
