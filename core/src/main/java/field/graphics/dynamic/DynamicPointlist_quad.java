 ...
 */
public
class DynamicPointlist_quad extends DynamicQuad_long implements iDynamicMesh {

    public
    DynamicPointlist_quad(QuadMesh_long from) {
        super(from);
    }
    ...
    public
    int nextVertexD(double x, double y, double z) {
    ...
    public
    void setAuxD(int vertex, int id, double a, double b, double c, double d) {
