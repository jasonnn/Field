...
public
class LineIdentifier implements iLineIdentifier {
    ...
    public
    LineIdentifier(iLineIdentifier identifier) {
        this.path = identifier.getName();
    }

    public
    LineIdentifier(String path) {
        this.path = path;
    }
    ...
    public
    LineIdentifier append(String unit) {
    ...
    public
    LineIdentifier prepend(String unit) {
        LineIdentifier i = new LineIdentifier();
