 ...
 */
public
class DynamicPointlist extends DynamicMesh implements iDynamicMesh {
    ...
    @Override
    public
    PointList getUnderlyingGeometry() {
    ...
    public static
    DynamicPointlist coloredPoints(BasicSceneList sceneList, float width) {
