...
public
class FrameRateThread {

    public
    FrameRateThread(Object canvas) {
        if (canvas instanceof FullScreenCanvasSWT) init((FullScreenCanvasSWT) canvas);
    }

    public
    FrameRateThread(final FullScreenCanvasSWT canvas) {
        init(canvas);
    }
