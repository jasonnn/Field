 ...
 */
public
class KeyboardControlledCamera extends CoordinateFrameCamera implements KeyListener {
     ...
     */
    public
    KeyboardControlledCamera(BasicCamera camera) {
        super(camera);
    ...
    void keyPressed(KeyEvent e) {
        ...
        if (!charactersDown.contains(d)) charactersDown.add(d);
    }
