...
class EigenStructure {
    ...
    class EigenStructureException extends RuntimeException {
        ...
        public
        EigenStructureException() {
            super();
        }

        public
        EigenStructureException(String message, Throwable cause) {
            super(message, cause);
        }

        public
        EigenStructureException(String message) {
            super(message);
        }

        public
        EigenStructureException(Throwable cause) {
            super(cause);
        }
    }
    ...
    class DimensionMismatchException extends RuntimeException {
        ...
        public
        DimensionMismatchException(String message, Throwable cause) {
            super(message, cause);
        }
        ...
        public
        DimensionMismatchException(Throwable cause) {
            super(cause);
        }
    }
     ...
     */
    public
    EigenStructure(MatrixN a) throws EigenStructureException, DimensionMismatchException {
        this(a.numRows());
     ...
     */
    public
    void performEigenDecomp(MatrixN a) throws EigenStructureException {
            ...
            for (ip = 0; ip < n - 1; ip++) {
                for (iq = ip + 1; iq < n; ++iq) {
                    ...
                    if (i > 3 && g < EPS) a[ip][iq] = 0.0;
                        ...
                        h = d[iq] - d[ip];
                        if (g < EPS) t = (Math.abs(a[ip][iq]) > EPS) ? (a[ip][iq]) / h : 0.0;
                        else {
