 ...
 */
public abstract
class Tuple4 implements java.io.Serializable, Cloneable {
     ...
     */
    public
    Tuple4 set(float x, float y, float z, float w) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.w = w;
     ...
     */
    public
    Tuple4 add(Tuple4 t1, Tuple4 t2) {
        this.x = t1.x + t2.x;
        this.y = t1.y + t2.y;
        this.z = t1.z + t2.z;
        this.w = t1.w + t2.w;
     ...
     */
    public
    Tuple4 sub(Tuple4 t1, Tuple4 t2) {
        this.x = t1.x - t2.x;
        this.y = t1.y - t2.y;
        this.z = t1.z - t2.z;
        this.w = t1.w - t2.w;
     ...
     */
    public
    Tuple4 scale(float s, Tuple4 t1) {
        this.x = s * t1.x;
        this.y = s * t1.y;
        this.z = s * t1.z;
        this.w = s * t1.w;
     ...
     */
    public
    Tuple4 scaleAdd(float s, Tuple4 t1, Tuple4 t2) {
        this.x = s * t1.x + t2.x;
        this.y = s * t1.y + t2.y;
        this.z = s * t1.z + t2.z;
        this.w = s * t1.w + t2.w;
     ...
     */
    public
    Tuple4 scaleAdd(float s, Tuple4 t1) {
     ...
     */
    public
    boolean epsilonEquals(Tuple4 t1, float epsilon) {
        float diff;
     ...
     */
    public
    Tuple4 clamp(float min, float max, Tuple4 t) {
        if (t.x > max) {
            x = max;
        }
        else if (t.x < min) {
     ...
     */
    public
    Tuple4 clampMin(float min, Tuple4 t) {
        if (t.x < min) {
            x = min;
        }
        else {
     ...
     */
    public
    Tuple4 clampMax(float max, Tuple4 t) {
        if (t.x > max) {
            x = max;
        }
        else {
     ...
     */
    public
    Tuple4 clamp(float min, float max) {
        if (x > max) {
            x = max;
        }
        else if (x < min) {
     ...
     */
    public
    Tuple4 interpolate(Tuple4 t1, Tuple4 t2, float alpha) {
     ...
     */
    public
    Tuple4 interpolate(Tuple4 t1, float alpha) {
