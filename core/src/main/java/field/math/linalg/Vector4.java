...
class Vector4 extends Tuple4 implements java.io.Serializable,
    ...
    public
    Vector4(double d, double e, double f, double g) {
     ...
     *
     * @param v1 the Vector4f containing the initialization x y z w
     *           data
     */
    public
    Vector4(Vector4 v1) {
    ...
    @Override
    public
    Vector4 absolute(Tuple4 t) {
        return (Vector4) super.absolute(t);
    }

    @Override
    public
    Vector4 add(Tuple4 t1) {
        return (Vector4) super.add(t1);
    }

    @Override
    public
    Vector4 add(Tuple4 t1, Tuple4 t2) {
        return (Vector4) super.add(t1, t2);
    }

    public
    Vector4 add(Vector4 t, Vector4 a, float thisLayerMultiplier) {
    ...
    public
    Vector4 blendRepresentation_add(Vector4 one, Vector4 two, Vector4 out) {
        if (out == null) return new Vector4(one).add(two);
        return out.setValue(one).add(two);
    }

    public
    Vector4 blendRepresentation_duplicate(Vector4 t) {
        return new Vector4(t);
    }

    public
    Vector4 blendRepresentation_multiply(float by, Vector4 input) {
        return new Vector4(input).scale(by);
    }

    public
    Vector4 blendRepresentation_newZero() {
        return new Vector4();
    }

    public
    Vector4 cerp(Vector4 before,
                 float beforeTime,
                 Vector4 now,
                 float nowTime,
                 Vector4 next,
    ...
    @Override
    public
    Vector4 clamp(float min, float max, Tuple4 t) {
        return (Vector4) super.clamp(min, max, t);
    }

    @Override
    public
    Vector4 clampMax(float max) {
        return (Vector4) super.clampMax(max);
    }

    @Override
    public
    Vector4 clampMax(float max, Tuple4 t) {
        return (Vector4) super.clampMax(max, t);
    }

    @Override
    public
    Vector4 clampMin(float min) {
        return (Vector4) super.clampMin(min);
    }

    @Override
    public
    Vector4 clampMin(float min, Tuple4 t) {
        return (Vector4) super.clampMin(min, t);
    }

    public
    float distanceFrom(Vector4 value) {
    ...
    public
    Vector4 hadd(Vector4 in, Vector3 to, float weight) {
    ...
    @Override
    public
    Vector4 interpolate(Tuple4 t1, float alpha) {
        return (Vector4) super.interpolate(t1, alpha);
    }

    @Override
    public
    Vector4 interpolate(Tuple4 t1, Tuple4 t2, float alpha) {
    ...
    public
    Vector4 lerp(Vector4 c0, Vector4 c1, float c) {
        float mc = (1 - c);
    ...
    public
    Vector4 lerp(Vector4 a, Vector4 b, Vector4 x) {
    ...
    @Override
    public
    Vector4 scale(float s, Tuple4 t1) {
        return (Vector4) super.scale(s, t1);
    }

    @Override
    public
    Vector4 scaleAdd(float s, Tuple4 t1) {
        return (Vector4) super.scaleAdd(s, t1);
    }

    @Override
    public
    Vector4 scaleAdd(float s, Tuple4 t1, Tuple4 t2) {
    ...
    @Override
    public
    Vector4 sub(Tuple4 t1) {
        return (Vector4) super.sub(t1);
    }

    @Override
    public
    Vector4 sub(Tuple4 t1, Tuple4 t2) {
