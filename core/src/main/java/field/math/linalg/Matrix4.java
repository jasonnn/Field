 ...
 */
public
class Matrix4 implements java.io.Serializable, Cloneable {
    ...
    //
    static
    void luBacksubstitution(double[] matrix1, int[] row_perm, double[] matrix2) {
        ...
        for (k = 0; k < 4; k++) {
            ...
            rv -= 4;
            matrix2[(cv + (4 * 2))] =
                    (matrix2[(cv + (4 * 2))] - (matrix1[rv + 3] * matrix2[cv + 4 * 3])) / matrix1[rv + 2];

            rv -= 4;
            matrix2[(cv + (4 * 1))] =
                    (matrix2[(cv + (4 * 1))] - (matrix1[rv + 2] * matrix2[cv + 4 * 2]) - (matrix1[rv + 3] * matrix2[cv
                                                                                                                    + 4
                                                                                                                      * 3]))
                    / matrix1[rv + 1];
    ...
    //
    static
    boolean luDecomposition(double[] matrix0, int[] row_perm) {
     ...
     *
     * @param m1 the rotation matrix representing the rotational
     *           components
     * @param t1 the translational components of the matrix
     * @param s  the scale value applied to the rotational components
     */
    public
    Matrix4(Matrix3 m1, Vector3 t1, float s) {
        this.m00 = m1.m00 * s;
        this.m01 = m1.m01 * s;
        this.m02 = m1.m02 * s;
        this.m03 = t1.x;
     ...
     */
    public
    Matrix4(Quaternion q1, Vector3 t1, float s) {
     ...
     */
    public
    Matrix4(Quaternion q1, Vector3 t1, Vector3 s) {
     ...
     */
    public final
    void add(float scalar, Matrix4 m1) {
    ...
    float determinant() {
        ...
        det = m00 * (((m11 * m22 * m33) + (m12 * m23 * m31) + (m13 * m21 * m32)) - (m13 * m22 * m31) - (m11
                                                                                                        * m23
                                                                                                        * m32) - (m12
                                                                                                                  * m21
                                                                                                                  * m33));
        det -= m01 * (((m10 * m22 * m33) + (m12 * m23 * m30) + (m13 * m20 * m32)) - (m13 * m22 * m30) - (m10
                                                                                                         * m23
                                                                                                         * m32) - (m12
                                                                                                                   * m20
                                                                                                                   * m33));
        det += m02 * (((m10 * m21 * m33) + (m11 * m23 * m30) + (m13 * m20 * m31)) - (m13 * m21 * m30) - (m10
                                                                                                         * m23
                                                                                                         * m31) - (m11
                                                                                                                   * m20
                                                                                                                   * m33));
        det -= m03 * (((m10 * m21 * m32) + (m11 * m22 * m30) + (m12 * m20 * m31)) - (m12 * m21 * m30) - (m10
                                                                                                         * m22
                                                                                                         * m31) - (m11
                                                                                                                   * m20
                                                                                                                   * m32));
     ...
     */
    public
    boolean epsilonEquals(Matrix4 m1, float epsilon) {
     ...
     */
    public final
    float get(Matrix3 m1, Vector3 t1) {
        double[] tmp_rot = new double[9]; // scratch matrix
        double[] tmp_scale = new double[3]; // scratch matrix
     ...
     */
    public final
    Quaternion get(Quaternion q1) {
        if (q1 == null) q1 = new Quaternion();
        double[] tmp_rot = new double[9]; // scratch matrix
        double[] tmp_scale = new double[3]; // scratch matrix
        getScaleRotate(tmp_scale, tmp_rot);
    ...
    public
    void get(Quaternion q1, Vector3 translation, Vector3 scale) {
     ...
     *
     * @param trans the vector that will receive the translational
     *              component
     */
    public final
    void get(Vector3 trans) {
        // !!
        trans.x = m03;
        trans.y = m13;
        trans.z = m23;
     ...
     * @param v      the array into which the matrix row values will be
     *               copied
     */
    public final
     ...
     *
     * @param column the matrix column
     * @param v      the vector into which the matrix row values will be
     *               copied
     */
    public final
    void getColumn(int column, Vector4 v) {
        if (column == 0) {
            v.x = m00;
            v.y = m10;
            v.z = m20;
     ...
     */
    public final
    void getRotationScale(Matrix3 m1) {
        m1.m00 = m00;
        m1.m01 = m01;
        m1.m02 = m02;
        m1.m10 = m10;
     ...
     */
    public final
    void invert(Matrix4 m1) {

        invertGeneral(m1);
    }

    public
    Matrix4 madd(float w, Matrix4 m) {
        this.m00 += w * m.m00;
        this.m01 += w * m.m01;
        this.m02 += w * m.m02;
        this.m03 += w * m.m03;
     ...
     */
    public final
    void mul(float scalar, Matrix4 m1) {
        this.m00 = m1.m00 * scalar;
        this.m01 = m1.m01 * scalar;
        this.m02 = m1.m02 * scalar;
        this.m03 = m1.m03 * scalar;
     ...
     */
    public final
    Matrix4 mul(Matrix4 m1, Matrix4 m2) {
        if ((this != m1) && (this != m2)) {
     ...
     * @param m2 the matrix on the right hand side of the
     *           multiplication
     */
    public final
    Matrix4 mulTransposeBoth(Matrix4 m1, Matrix4 m2) {
        if ((this != m1) && (this != m2)) {
     ...
     */
    public final
    Matrix4 mulTransposeLeft(Matrix4 m1, Matrix4 m2) {
        if ((this != m1) && (this != m2)) {
     ...
     */
    public final
    void mulTransposeRight(Matrix4 m1, Matrix4 m2) {
        if ((this != m1) && (this != m2)) {
     ...
     */
    public final
    void set(float scale, Vector3 t1) {
        this.m00 = scale;
        this.m01 = (float) 0.0;
        this.m02 = (float) 0.0;
        this.m03 = t1.x;
     ...
     */
    public final
    void set(Matrix3 m1, Vector3 t1, float scale) {
     ...
     */
    public final
    void set(Quaternion q1, Vector3 t1, float s) {
    ...
    public
    void set(Quaternion q1, Vector3 t1, Vector3 s) {
        if (Math.abs(q1.mag() - 1) > 0.2) throw new IllegalArgumentException("not normalized <" + q1 + '>');
     ...
     */
    public final
    void set(Vector3 t1, float scale) {
        this.m00 = scale;
        this.m01 = (float) 0.0;
        this.m02 = (float) 0.0;
        this.m03 = scale * t1.x;
    ...
    public
    void setColumn(int column, Vector3 v) {
        switch (column) {
            case 0:
                this.m00 = v.x;
                this.m10 = v.y;
     ...
     */
    public final
    void setColumn(int column, Vector4 v) {
        switch (column) {
            case 0:
                this.m00 = v.x;
                this.m10 = v.y;
     ...
     */
    public final
    Matrix4 setRotation(Matrix3 m1) {
        double[] tmp_rot = new double[9]; // scratch matrix
        double[] tmp_scale = new double[3]; // scratch matrix
     ...
     */
    public final
    Matrix4 setRotation(Quaternion q1) {
        double[] tmp_rot = new double[9]; // scratch matrix
        double[] tmp_scale = new double[3]; // scratch matrix
        getScaleRotate(tmp_scale, tmp_rot);
     ...
     */
    public final
    void setRotationScale(Matrix3 m1) {
        m00 = m1.m00;
        m01 = m1.m01;
        m02 = m1.m02;
        m10 = m1.m10;
     ...
     */
    public final
    Matrix4 setTranslation(Vector3 trans) {
        m03 = trans.x;
        m13 = trans.y;
        m23 = trans.z;
        return this;
     ...
     */
    public final
    void sub(Matrix4 m1, Matrix4 m2) {
        this.m00 = m1.m00 - m2.m00;
        this.m01 = m1.m01 - m2.m01;
        this.m02 = m1.m02 - m2.m02;
        this.m03 = m1.m03 - m2.m03;
     ...
     */
    public final
    <T extends Tuple4> T transform(T vec) {
        float x, y, z;
     ...
     *
     * @param vec    the single precision vector to be transformed
     * @param vecOut the vector into which the transformed values are
     *               placed
     */
    public final
    void transform(Tuple4 vec, Tuple4 vecOut) {
        float x, y, z;
        x = m00 * vec.x + m01 * vec.y + m02 * vec.z + m03 * vec.w;
        y = m10 * vec.x + m11 * vec.y + m12 * vec.z + m13 * vec.w;
        z = m20 * vec.x + m21 * vec.y + m22 * vec.z + m23 * vec.w;
     ...
     */
    public final
    Vector3 transformDirection(Vector3 normal) {
        float x, y;
     ...
     */
    public final
    Vector3 transformDirection(Vector3 normal, Vector3 normalOut) {
        if (normalOut == null) normalOut = new Vector3();
        float x, y;
        x = m00 * normal.x + m01 * normal.y + m02 * normal.z;
        y = m10 * normal.x + m11 * normal.y + m12 * normal.z;
     ...
     */
    public final
    Vector3 transformPosition(Vector3 point) {
        float x, y;
     ...
     */
    public final
    void transformPosition(Vector3 point, Vector3 pointOut) {
        float x, y;
        x = m00 * point.x + m01 * point.y + m02 * point.z + m03;
        y = m10 * point.x + m11 * point.y + m12 * point.z + m13;
    ...
    private final
    void getScaleRotate(double[] scales, double[] rots) {
     ...
     */
    final
    Matrix4 invertGeneral(Matrix4 m1) {
    ...
    public
    float minusIdentityFrobenius() {
        float m = ((this.m00 - 1) * (this.m00 - 1)) + (this.m01 * this.m01) + (this.m02 * this.m02) + (this.m03
                                                                                                       * this.m03);
    ...
    public static
    Matrix4 alexaInterpolate(Matrix4 a, Matrix4 b, float t) {
        a = new Matrix4(a);
        b = new Matrix4(b);
