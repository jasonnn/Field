 ...
 */
public
class AxisAngle implements java.io.Serializable, Cloneable {
     ...
     */
    public
    boolean epsilonEquals(AxisAngle a1, float epsilon) {
        float diff;
