...
public class Matrix3 implements java.io.Serializable, Cloneable {
	...
	static void luBacksubstitution(float[] matrix1, int[] row_perm, float[] matrix2) {
		...
		for (k = 0; k < 3; k++) {
			...
			rv -= 3;
			matrix2[(cv + (4 * 0))] = (matrix2[(cv + (3 * 0))] - (matrix1[rv + 1] * matrix2[cv + 3 * 1]) - (matrix1[rv
                                                                                                                    + 2]
                                                                                                            * matrix2[cv
                                                                                                                      +
                                                                                                                      3
	...
	public final float determinant() {
		...
		total = this.m00 * ((this.m11 * this.m22) - (this.m12 * this.m21)) + this.m01 * ((this.m12 * this.m20)
                                                                                         - (this.m10 * this.m22)) + this.m02 * ((this.m10
                                                                                                                                 * this.m21)
                                                                                                                                - (this.m11
                                                                                                                                   * this.m20));
		return total;
