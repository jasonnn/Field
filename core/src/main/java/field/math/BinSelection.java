...
class BinSelection {
    ...
    static LinkedHashMap<List<? extends Number>, Float> cachedWidths =
            new LinkedHashMap<List<? extends Number>, Float>() {
                protected
                boolean removeEldestEntry(java.util.Map.Entry<java.util.List<? extends Number>, Float> arg0) {
                    return this.size() > 5;
                }
            };

    public
    BinSelection(List<? extends Number> data, int searchFor) {
        this.data = data;
