...
class Jvec {
    ...
    class FFTInit {
        ...
        public
        int readRealTransform(int element) {
            if (element == 0) return 0;
            if (element == (size - 1)) return 1;
            return element + 1;
        }
    ...
    public
    void complexToMagnitude(FloatBuffer realIn, FloatBuffer imagIn, FloatBuffer magOut) {
//		assert(
...
//				&& (imagIn.capacity() == magOut.capacity())) : "dimension mismatch";
    ...
    public
    void complexToMagnitudePhase(FloatBuffer realIn, FloatBuffer imagIn, FloatBuffer magOut, FloatBuffer phaseOut) {
        assert ((realIn.capacity() == imagIn.capacity())
    ...
    public
    void convertARGBToFloat(ByteBuffer inBuffer, FloatBuffer outBuffer) {
        nativeConvertARGBToFloat(inBuffer, outBuffer, outBuffer.capacity());
    }

    public native
    void fastNDCBoundingBox(FloatBuffer model,
    ...
    public
    int findMaxMag(FloatBuffer buffer) {
        return nativeFindMaxMag(buffer, buffer.capacity());
    }

    public
    int findMinAbs(FloatBuffer buffer) {
        return nativeFindMinAbs(buffer, buffer.capacity());
    }


    public native
    void freeAlignedStorage(Buffer b);

    // dsp code --------------------------------------------------------------------------------------------------------------------------
    public
    FFTInit initializeFFT(int log2Size) {
    ...
    public native
    ByteBuffer newAlignedStorage(int i);
...
//		vzero(f);
    ...
    public
    void performComplex2DFFTOutOfPlace(FFTInit i, FloatBuffer in, FloatBuffer inI, FloatBuffer outR, FloatBuffer outI) {
    ...
    public native
    void performComplex2DFFTOutOfPlace(int ref,
                                       FloatBuffer in,
                                       FloatBuffer zero,
                                       FloatBuffer outR,
                                       FloatBuffer outI,
    ...
    public
    void performComplexFFT(FFTInit init, FloatBuffer realInplace, FloatBuffer imagInplace, boolean forward) {
        performComplexFFT(init.ref, realInplace, imagInplace, init.tempI, init.tempO, init.log2Size, forward ? 1 : 0);
    }

    public native
    void performComplexFFT(int i,
                           FloatBuffer inR,
                           FloatBuffer outI,
                           FloatBuffer temp1,
                           FloatBuffer temp2,
    ...
    // might be what you are looking for if you want a round trip to not scale by len
    public
    void performComplexFFTOutOfPlace(FFTInit init,
                                     FloatBuffer realIn,
                                     FloatBuffer imagIn,
                                     FloatBuffer realOut,
                                     FloatBuffer imagOut,
                                     boolean forward) {
        performComplexFFTOutOfPlace(init.ref,
                                    realIn,
                                    imagIn,
                                    realOut,
                                    imagOut,
    ...
    public native
    void performComplexFFTOutOfPlace(int i,
                                     FloatBuffer inR,
                                     FloatBuffer inI,
                                     FloatBuffer outR,
                                     FloatBuffer outI,
    ...
    public native
    void performComplexToM(FloatBuffer r, FloatBuffer i, FloatBuffer m, int ll);


    public native
    void performComplexToMP(FloatBuffer r, FloatBuffer i, FloatBuffer m, FloatBuffer p, int ll);
    ...
    public
    void performReal2DFFTOutOfPlace(FFTInit i, FloatBuffer in, FloatBuffer zero, FloatBuffer outR, FloatBuffer outI) {
        int l2 = (int) (Math.log(Math.sqrt(in.capacity())) / Math.log(2));
        int w = (int) Math.sqrt(in.capacity());
    ...
    public native
    void performReal2DFFTOutOfPlace(int ref,
                                    FloatBuffer in,
                                    FloatBuffer zero,
                                    FloatBuffer outR,
                                    FloatBuffer outI,
    ...
    // actually, the docs are not clear enough to know what is going on. use performComplexFFT
    public
    void performRealFFT(FFTInit init, FloatBuffer realInplace, FloatBuffer imagOut) {
    ...
    public
    float v4VecHausdorff(FloatBuffer a, FloatBuffer b, float max) {
        return v4VecHausdorff(a, a.remaining(), b, b.remaining(), max);
    }

    public native
    float v4VecHausdorff(FloatBuffer a, int i, FloatBuffer b, int j, float max);
    ...
    public
    void vadd(FloatBuffer one, float scalar, FloatBuffer result) {
        // coded out underneal
    ...
    public
    void vadd(FloatBuffer one, FloatBuffer two, FloatBuffer result) {
    ...
    public
    void vam(FloatBuffer one, FloatBuffer two, FloatBuffer three, FloatBuffer out) {
    ...
    public
    void vcascadelowpass(FloatBuffer input, int startAt, float alpha) {
        vcascadelowpass(input, alpha, startAt, input.capacity());
    }

    public
    void vdistancematrix(FloatBuffer from, FloatBuffer to) {
    ...
    public
    void vdistancematrixToScalar(FloatBuffer from, FloatBuffer to) {
    ...
    public
    void vdiv(FloatBuffer one, FloatBuffer two, FloatBuffer result) {
    ...
    public
    float vdot(FloatBuffer one, FloatBuffer two) {
    ...
    public
    void vinterleave(FloatBuffer one, FloatBuffer two, FloatBuffer out) {
    ...
    public
    float vlpf(FloatBuffer outFilter, FloatBuffer inFilter, float filterConstant) {
        assert outFilter.capacity() == inFilter.capacity();
        return vlpf(outFilter, inFilter, filterConstant, outFilter.capacity());
    }

    public
    float vlpf_sqr(FloatBuffer outFilter, FloatBuffer inFilter, float filterUp, float filterDown) {
        assert outFilter.remaining() == inFilter.remaining();
        return vlpfabs(outFilter, inFilter, filterUp, filterDown, outFilter.capacity());
    }

    public
    float vlpf_sqr_diff(FloatBuffer outFilter,
                        FloatBuffer inFilterA,
                        FloatBuffer inFilterB,
                        float filterUp,
                        float filterDown) {
     ...
     */
    public
    void vmadd(FloatBuffer temp2, float f, FloatBuffer temp1, FloatBuffer temp12) {
    ...
    public
    int vmin4Distance(float x, float y, float z, float w, FloatBuffer to) {
    ...
    public
    void vmul(FloatBuffer one, float scalar, FloatBuffer result) {
        vmulS(one, scalar, result, one.capacity());
    }

    public
    void vmul(FloatBuffer one, FloatBuffer two, FloatBuffer result) {
    ...
    public
    void vmulscalaraddvec(FloatBuffer one, float mulOne, FloatBuffer addScaledOne, FloatBuffer result) {
    ...
    public
    LongBuffer vran0(LongBuffer seed, FloatBuffer buffer) {
    ...
    public
    void vrefreshdistancematrix(FloatBuffer input, FloatBuffer distances, int cursor) {
    ...
    public
    void vsub(FloatBuffer one, FloatBuffer two, FloatBuffer result) {
    ...
    private native
    float vlpfabsdiff(FloatBuffer outFilter,
                      FloatBuffer inFilterA,
                      FloatBuffer inFilterB,
                      float filterUp,
                      float filterDown,
    ...
    native
    void vzero(FloatBuffer t1, int l);
