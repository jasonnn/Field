...
//		return Math.acos(clamp(cos_theta, -1.0, 1.0));
     ...
     */
    public static
    double safePow(double x, double pow) {
        int sign = pow < 0 ? -1 : 1;
        return Math.pow(x * sign, pow) * sign;
    }

    static final double[] sinc_lookup = {1.0000000000000000e+000,
    ...
    private static final double SINC_EPSILON = .001;
     ...
     */
    public static
    int intify(byte argh) {
        return (argh < 0 ? ((int) argh) + 256 : (int) argh);
    }
     ...
     */
    public static
    int intify(short argh) {
        return (argh < 0 ? ((int) argh) + 256 * 256 : (int) argh);
    }
     ...
     */
    public static
    long longify(int argh) {
        return (argh < 0 ? ((long) argh) + 4294967296L : (long) argh);
    }
     ...
     */
    public static
    String toDP(double number, int i) {
        if (_format == null) {
    ...
    public static
    String toDPMax(double number, int i) {
        if (_format == null) {
            _format = NumberFormat.getInstance();
        }
        // if (_lastDigits != i)
    ...
    private static NumberFormat _format = null;

    private static int _lastDigits = -1;
    ...
    class MutableFloat extends Number implements iFloatProvider,
        ...
        public
        MutableFloat(float d) {
            this.d = d;
        }

        public
        MutableFloat(double d) {
            this.d = d;
        }
        ...
        public
        MutableFloat cerp(MutableFloat before,
                          float beforeTime,
                          MutableFloat now,
                          float nowTime,
                          MutableFloat next,
        ...
        public
        MutableFloat lerp(MutableFloat before, MutableFloat now, float a) {
            this.d = before.d + (now.d - before.d) * a;
            return this;
        }

        public
        MutableFloat setValue(MutableFloat to) {
            this.d = to.d;
            return this;
        }

        public
        MutableFloat blendRepresentation_newZero() {
    ...
    public static
    boolean floatEqualTo(float a, float b) {
