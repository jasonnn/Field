...
public class BaseMath {
	 ...
	 */
	public static  double acos(double cos_theta) {
...
//		return Math.acos(clamp(cos_theta, -1.0, 1.0));
	 ...
	 */
	public static  double asin(double sin_theta) {
	 ...
	 */
    public static
    class MutableFloat extends Number implements iFloatProvider, Comparable<Number>, iBlendable<MutableFloat>, iToFloatArray {
