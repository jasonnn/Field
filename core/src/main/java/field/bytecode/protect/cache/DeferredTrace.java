...
public final
class DeferredTrace extends DeferCallingFast {

    private final HashMap<String, Object> parameters;
    Method original = null;

    public
    DeferredTrace(String name,
                  int access,
                  ASMMethod method,
    ...
    Object handle(int fromName, Object fromThis, String originalMethod, Object[] argArray) {
        ...
        try {
            ...
            if (!success) ;//System.out.println("<< (exception) "+originalMethod+" "+System.identityHashCode(fromThis));
        }
        return null;
    }
}