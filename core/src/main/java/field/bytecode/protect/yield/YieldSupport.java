...
class YieldSupport {
    ...
    public
    int yieldIndexFor(String uniq, Object fromThis, HashMap<String, Object> parameters) {
    ...
    public
    Object yieldStore(Object wasReturn, Object[] localStorage, String string, Object fromThis, int resumeLabel) {
    ...
    public
    Object[] yieldLoad(Object fromThis) {
    ...
    public static
    void setYieldInfoFor(Object on, YieldInfo y) {
        YieldInfo info = globalYieldInfo.get(on);
        if (info == null) assert false : " no global yield info for <"
                                         + on
                                         + "> this probably means that set yield info for was either called while this method was executing, after this method >returned< rather than yielded, or before this method was ever called";
