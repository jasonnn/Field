...
public
class NoopSecurityManager extends SecurityManager {
    ...
    @Override
    public
    void checkMemberAccess(Class<?> arg0, int arg1) {
    }
    ...
    @Override
    public
    boolean checkTopLevelWindow(Object arg0) {
        return true;
    }
