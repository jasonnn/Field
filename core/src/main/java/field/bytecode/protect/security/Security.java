...
public class Security {
    public static interface SecurityManagerChangeListener {
    ...
    public void setSecurityManager(SecurityManager newManager) {
    ...
    public void usePermissiveSecurityManager() {
        setSecurityManager(new PermissiveSecurityManager());
    }

    public void useNoWriteSecurityManager() {
        setSecurityManager(new NoWriteSecurityManager());
    }

    public void useNoopSecurityManager() {
        setSecurityManager(new NoopSecurityManager());
    }

    public void useCollectResourcesSecurityManager() {
        setSecurityManager(new CollectResourcesSecurityManager());
    }

    private final List<SecurityManagerChangeListener> listeners = new CopyOnWriteArrayList<SecurityManagerChangeListener>();

    public Registration addSecurityManagerListener(final SecurityManagerChangeListener listener) {
    ...
    public void removeSecurityManagerListener(SecurityManagerChangeListener listener) {
