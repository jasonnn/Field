...
class ModificationCache {
    ...
    class Modification implements Serializable {
        ...
        public
        Modification(boolean instrumented, long at) {
            super();
    ...
    public
    boolean is(String name, boolean def, long at) {
    ...
    public
    void state(String name, boolean is, long at) {
    ...
    <T> T persist(String name, T defaultValue) {
        ...
        final String filename =
                System.getProperty("user.home") + "/Library/Application Support/Field" + '/' + name + ".xml";
        try {
