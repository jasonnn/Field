...
public class SimplyWrappedInQueue extends DeferCallingFast {
    ...
    public SimplyWrappedInQueue(String name, int access, ASMMethod onMethod, ClassVisitor classDelegate, MethodVisitor delegateTo, String signature, HashMap<String, Object> parameters) {
