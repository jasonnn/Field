...
//					&& (("pause".equals(name)) || ("call".equals(name) && "(Ljava/lang/String;)Ljava/lang/Object;".equals(desc)))) 
     ...
     * @param desc   the operand of the instruction to be visited. This operand is must be a fully qualified class name in internal form, or the type descriptor of an array type (see {@link Type Type}).
     */
    public
     ...
     *
     * @param cst the constant to be loaded on the stack. This parameter must be a non null {@link java.lang.Integer Integer}, a {@link java.lang.Float Float}, a {@link java.lang.Long Long}, a {@link java.lang.Double Double} or a {@link String String}.
     */
    public
     ...
     *
     * @param opcode the opcode of the instruction to be visited. This opcode is either NOP, ACONST_NULL, ICONST_M1, ICONST_0, ICONST_1, ICONST_2, ICONST_3, ICONST_4, ICONST_5, LCONST_0, LCONST_1, FCONST_0, FCONST_1, FCONST_2, DCONST_0, DCONST_1,
     *               <p/>
            ...
            switch (opcode) {
                ...
                case NEWARRAY:
                    ...
                    switch (operand) {
                        case T_BOOLEAN:
                            mCurrentNode.addInstruction(new TypesInstruction(TypesOpcode.PUSH,
                                                                             TypesContext.ARRAY_BOOLEAN));
                            break;
                        case T_CHAR:
                            mCurrentNode.addInstruction(new TypesInstruction(TypesOpcode.PUSH,
                                                                             TypesContext.ARRAY_CHAR));
                            break;
                        case T_FLOAT:
                            mCurrentNode.addInstruction(new TypesInstruction(TypesOpcode.PUSH,
                                                                             TypesContext.ARRAY_FLOAT));
                            break;
                        case T_DOUBLE:
                            mCurrentNode.addInstruction(new TypesInstruction(TypesOpcode.PUSH,
                                                                             TypesContext.ARRAY_DOUBLE));
                            break;
                        case T_BYTE:
                            mCurrentNode.addInstruction(new TypesInstruction(TypesOpcode.PUSH,
                                                                             TypesContext.ARRAY_BYTE));
                            break;
                        case T_SHORT:
                            mCurrentNode.addInstruction(new TypesInstruction(TypesOpcode.PUSH,
                                                                             TypesContext.ARRAY_SHORT));
                            break;
                        case T_INT:
    ...
    private
    void processInstructions(TypesNode node) {
            ...
            switch (instruction.getOpcode()) {
                case TypesOpcode.SET: {
                    ...
                    if (node.getPreceeder() != null
                        ...
                        && (null == current_var_type || (!current_var_type.equals(TypesContext.NULL)
                                                         && !current_var_type.equals(type)))) {
                        context.cloneVars();
                    }
