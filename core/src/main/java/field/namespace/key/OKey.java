...
class OKey<T> extends CKey implements IProvider<T> {
    ...
    public
    OKey(String s, SimpleContextTopology ct) {
        super(s, ct);
        pushRoot().lookup(getName()).pop();
    }
    ...
    T get() {
        ...
        if (o == nothing) throw new IllegalArgumentException(" ran OKey <"
                                                             + this
    ...
    T get(T def) {
        ...
        if (o == failure) throw new IllegalArgumentException(" ran OKey <"
                                                             + this
                                                             + ">, with default <"
                                                             + def
                                                             + ">got failure <"
