...
class SimpleGraphLayout {
    ...
    public
    SimpleGraphLayout(float d1, float d2) {
        this.d1 = d1;
        this.d2 = d2;
    }
    ...
    void layoutLevel2(Object root,
        ...
        while (ff.hasNext()) {
            ...
            if (r.containsKey(o)) {
                ...
                else edgeTypes.put(new Pair<Object, Object>(root, o), EdgeType.level1_level2_other);
                ...
                while (fff.hasNext()) {
                    ...
                    else edgeTypes.put(new Pair<Object, Object>(o, oo), EdgeType.fringe);
                }
            }
            forward.rotateBy((float) (Math.PI / 2 / (n + 1)));
