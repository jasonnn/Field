...
public
class ExternalHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, Cloneable, Serializable {
    ...
    interface iEquality<T> {
        ...
        public
        int hashCodeFor(T o1);
    }

    iEquality<K> equality = new iEquality<K>() {
        public
        boolean areEqual(K o1, K o2) {
            return o1.equals(o2);
        }

        public
        int hashCodeFor(K o1) {
            return o1.hashCode();
        }
    };

    public
    ExternalHashMap<K, V> setEquality(iEquality<K> equality) {
     ...
     */
    public
    ExternalHashMap(int initialCapacity, float loadFactor) {
     ...
     */
    public
    ExternalHashMap(int initialCapacity) {
     ...
     */
    public
    ExternalHashMap(Map<? extends K, ? extends V> m) {
     ...
     */
    static
    boolean eq(Object x, Object y, iEquality e) {
    ...
    Entry<K, V> getEntry(Object key) {
        ...
        int i = indexFor(hash, table.length);
        Entry<K, V> e = table[i];
        while ((e != null) && !(e.hash == hash && eq(k, e.key, equality))) e = e.next;
        return e;
    }
    ...
    class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public
        K getKey() {
            return ExternalHashMap.unmaskNull(key);
        }
