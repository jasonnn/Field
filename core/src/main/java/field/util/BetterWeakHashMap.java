...
public
class BetterWeakHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V> {
    ...
    class BaseWeakHashMapKey implements iWeakHashMapKey {
        ...
        public
        Object getWHMKValue(Object inside) {
        ...
        public
        void setWHMKValue(Object inside, Object to) {
     ...
     */
    public
    BetterWeakHashMap(int initialCapacity) {
     ...
     */
    public
    BetterWeakHashMap(int initialCapacity, float loadFactor) {
