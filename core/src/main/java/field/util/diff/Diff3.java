...
class Diff3 {
    ...
    public
    Diff3(String primary, String old, String secondary) {
        ...
        // remove any deletion from rel2 that overlaps with any non-equivalant change
        {
            ...
            while (i1.hasNext()) {
                ...
                if (n1.getPayload().type != EditType.equivalence) {
                    List<iMarker<ChannelDifferences<Character>.EditRelationship>> se =
                            rel2.getSlice(n1.getTime(), n1.getTime() + n1.getDuration()).getIterator().remaining();
            ...
            if ((n1 == null) || (n1.getPayload().type == EditType.equivalence)) {
                if ((n2 == null) || (n2.getPayload().type == EditType.equivalence)) {
                    if (n1 != null) {
                        ...
                        if (n2 != null) {
                            assert n1.getPayload().left.get(0)
                                                       .getPayload()
                                                       .equals(n2.getPayload().left.get(0).getPayload()) : n1
                                                                                                           + "!= "
                                                                                                           + n2;
                        }
                    }
