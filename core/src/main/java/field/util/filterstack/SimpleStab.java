...
public
class SimpleStab<T> extends ConstantUnit<T> {

    private final double duration;

    public
    SimpleStab(String name, double duration, T constant) {
        super(name, constant);
    ...
    public
    SimpleStab(String name, double duration, T constant, float middle) {
        super(name, constant);
        this.duration = duration;
