...
class ConstantUnit<T> extends Unit<T> {
    ...
    public
    ConstantUnit(String name, T constant) {
        super(name);
    ...
    public
    ConstantUnit<T> setConstant(T constant) {
    ...
    public
    ConstantUnit<T> setBlendInputName(String name) {
        this.blendInputName = name;
        return this;
    }

    public
    ConstantUnit<T> setBlendOutputName(String name) {
