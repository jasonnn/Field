...
class FluidPersistence {
    ...
    public
    interface iRequiresSerialization {
    }
    ...
    public
    FluidPersistence(final iWellKnownElementResolver resolver) {
        this(resolver, 0);
    }

    public
    FluidPersistence(final iWellKnownElementResolver resolver, int version) {
                ...
                Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
                    ...
                    try {
                        ...
                        ObjectInputStream ois =
                                new ObjectInputStream(new ByteArrayInputStream(new Base64().decode(value)));
