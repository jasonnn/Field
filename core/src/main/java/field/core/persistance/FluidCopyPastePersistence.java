...
public
class FluidCopyPastePersistence {


    public
    interface iNotifyDuplication {
        public
    ...
    public
    FluidCopyPastePersistence(final iWellKnownElementResolver resolver, final iNotifyDuplication duplication) {
        this(resolver, duplication, 1);
    }

    public
    FluidCopyPastePersistence(final iWellKnownElementResolver resolver,
                              final iNotifyDuplication duplication,
                              int version) {
            ...
            MapperWrapper wrapMapper(MapperWrapper next) {
                return new MapperWrapper(next) {
                    ...
                    Class realClass(String elementName) {
                        ...
                        if (elementName.equals(iMixinProxy.class.getName().replace("$", "-"))) return iMixinProxy.class;
                        try {
