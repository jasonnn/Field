...
public
class NewInspectorFromProperties {

    private final NewInspector2 inside;

    public
    NewInspectorFromProperties(NewInspector2 inside) {
        this.inside = inside;
    }

    public static LinkedHashMap<String, Class<? extends BaseControl>> knownProperties =
    ...
    public static List<Triple<String, LinkedHashMap<String, Class<? extends BaseControl>>, Boolean>> activeSets =
            new ArrayList<Triple<String, LinkedHashMap<String, Class<? extends BaseControl>>, Boolean>>();
    ...
    public
    ArrayList<BaseControl> complete() {
    ...
    private
    iIO<Object> getHeading(final String string) {
    ...
    Class<? extends BaseControl> componentForValue(Object value) {
        ...
        if (value instanceof Number) return SpinnerControl.class;
