...
class MarkingMenuBuilder {
    ...
    public
    MarkingMenuBuilder setInverted(boolean invert) {
        this.inverted = invert;
        return this;
    }

    public
    PopupMarkingArea getMenu(Control invoker, Point screen) {
        ...
        for (PopupMarkingArea.PopMenuSpec s : spec.values()) {
            if ((s.menu != null) && s.menu.isEmpty()) s.menu = null;
        ...
        PopupMarkingArea m =
                new PopupMarkingArea(invoker, new Point(screen.x, screen.y), new ArrayList<PopMenuSpec>(spec.values()));
    ...
    public
    MarkingMenuBuilder defaultMenu() {
    ...
    public
    void setSingleActionFunction(PyObject f) {
        this.singleAction = wrap(f);
    }

    public
    MarkingMenuBuilder marking(String defaultName, String position) {
    ...
    public
    MarkingMenuBuilder newMenu(String defaultName, String defaultPosition) {
    ...
    private
    Position nextUnalloc(String defaultPosition) {
    ...
    public
    MarkingMenuBuilder call(PyObject u) {
        return call(wrap(u));
    }
...
//			text = "<b>" + text+"</b>";
    ...
    public
    MarkingMenuBuilder subtitle(String text) {
        return addUpdateable(text, null);
    }

    public
    MarkingMenuBuilder add(String text, PyObject u) {
    ...
    public
    MarkingMenuBuilder add(String icon, String text, PyObject u) {
    ...
    public
    void setExtraArguments(Object[] extraArguments) {
    ...
    IUpdateable wrap(final PyObject u) {
        ...
        return new IUpdateable() {
            ...
            void update() {
                ...
                env.enter();
                try {
                    if (extraArguments == null) u.__call__();
                    else {
    ...
    public
    MarkingMenuBuilder mergeWith(MarkingMenuBuilder u) {
        ...
        }
        {
            ...
            for (Entry<Position, PopMenuSpec> e : es) {
                ...
                else b.spec.put(e.getKey(), e.getValue().copy());
            }
        }
