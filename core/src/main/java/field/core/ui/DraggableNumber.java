 ...
 */
public
class DraggableNumber extends JComponent implements MouseListener, MouseMotionListener, ComponentListener {
...
//		draggerRightWidth = draggerRight.getWidth(null);
    ...
    public
    void setStatusMixed(double value) {
    ...
    public
    void setStatusUnset(double value) {
        boolean changed = !" ".equals(numberField.getText());
        this.value = clampValue(value);
        String formattedNumber = numberFormat.format(getValue());
        numberField.setText(" ");
    ...
    public
    void setValueFromString(String s) throws NumberFormatException {
    ...
    private
    Rectangle getLeftButtonRect(Rectangle r) {
        if (r == null) r = getBounds();
        return new Rectangle(r.x, r.y, draggerLeftWidth, draggerHeight);
    }

    private
    Rectangle getRightButtonRect(Rectangle r) {
        if (r == null) r = getBounds();
...
//		}
    ...
    void mouseReleased(MouseEvent e) {
        if (oldValue != value) fireStateChanged();
    }
    ...
    class EscapeListener extends KeyAdapter {
        ...
        void keyPressed(KeyEvent e) {
            if (e.getKeyCode() == KeyEvent.VK_ESCAPE) numberField.setVisible(false);
        }
    }
}
