...
public
class OpportunisticSlider2 {

    private final BaseTextEditor2 inside;

    public
    OpportunisticSlider2(BaseTextEditor2 b) {
        this.inside = b;
        ...
        inside.rulerCanvas.addPaintListener(new PaintListener() {
            ...
            @Override
            public
            void paintControl(PaintEvent arg0) {
                ...
                if (isInteger(text) || isFloat(text)) {
                    ...
                    if (best != null) {
                        ...
                        arg0.gc.setForeground(new Color(Launcher.display, 0, 0, 0));
                        arg0.gc.setAlpha(128);
                        arg0.gc.setLineDash(new int[]{2, 2});
                        arg0.gc.drawLine(arg0.width, (int) cy, arg0.width - 15, (int) cy);
...
//						arg0.gc.drawLine((int)(arg0.width-15), (int)cy, (int)midx, (int)midy);
    ...
    public
    void scroll(int arg0, boolean exec) {
                ...
                deferedUpdate.new Task("q") {
                    ...
                    void run() {
                        ...
                        if (t == 4) {
                            ...
                            Area best = inside.executionRuler.getCurrentArea();
//							Area best = inside.executionRuler.getMin(inside.ed.getSelection().x);
                            if (best != null) inside.executionRuler.executeArea(best);
                        }
