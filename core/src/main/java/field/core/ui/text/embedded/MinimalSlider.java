...
public
class MinimalSlider extends JComponent implements iAcceptsInsertRenderingContext {
    ...
    class Component extends ProvidedComponent {
        ...
        public
        void preserialize() {
            if (component != null) when = ((MinimalSlider) component).when;
            if (component != null) what = ((MinimalSlider) component).what;
        }
    ...
    class Component_iFloatProvider extends Component {
        ...
        public
        String getCurrentRepresentedString() {
            if (localKey == null) localKey = new FKey(name).rootSet(value);
...
//		g2.setColor(new Color(0.22f, 0.22f, 0.2f, 0.4f));
        ...
        if (on) g2.fillRect(leftX, 2, rightX - leftX, 12);
