 ...
 */
public
class InterpretPythonAsDelegate {

    public
    interface iDelegateForReturnValue {
        public
    ...
    static {
        factories.add(new iDelegateForReturnValue() {
            ...
            Delegate delegateForReturnValue(float t,
                                            ...
                                            final Object ret,
                                            final boolean noDefaultBackwards) {
                if (ret instanceof Number) return new Delegate() {
                    ...
                    void continueToBeActive(float t, Promise p, boolean forwards) {
                        ...
                        if (!(forwards || !noDefaultBackwards)) return;
                        if (downwards != null) downwards.continueToBeActive(t, p, forwards);
                        else {
                            ...
                            try {
                                ...
                                tr.printStackTrace();
                                throwExceptionInside("trying to evaluate _r while continuing to be active",
                                                     p.getOngoingEnvironments(),
                                                     tr);
                    ...
                    void jumpStop(float t, Promise p, boolean forwards) {
                        ...
                        p.wontExecute();
                        if (!(forwards || !noDefaultBackwards)) return;
                        if (downwards != null) downwards.jumpStop(t, p, forwards);
                    }
                    ...
                    void start(float t, Promise p, boolean forwards) {
                        ...
                        p.willExecute();
                        if (!(forwards || !noDefaultBackwards)) return;
                        if (downwards != null) downwards.start(t, p, forwards);
                    }
                    ...
                    void startAndStop(float t, Promise p, boolean forwards) {
                        ...
                        if (!(forwards || !noDefaultBackwards)) return;
                        if (downwards != null) downwards.startAndStop(t, p, forwards);
                    }
                    ...
                    void stop(float t, Promise p, boolean forwards) {
                        ...
                        p.wontExecute();
                        if (!(forwards || !noDefaultBackwards)) return;
                        if (downwards != null) downwards.stop(t, p, forwards);
                    }
                };
                return null;
            }
                    ...
                    return new Delegate() {
                        ...
                        void continueToBeActive(float t, Promise p, boolean forwards) {
                            ...
                            try {
                                ...
                                tr.printStackTrace();
                                throwExceptionInside("trying to evaluate function stack",
                                                     p.getOngoingEnvironments(),
                                                     tr);
                    ...
                    return new Delegate() {
                        ...
                        void continueToBeActive(float t, Promise p, boolean forwards) {
                            ...
                            try {
                                ...
                                System.err.println(" exception throw while executing python ...<" + tr + '>');
                                tr.printStackTrace();
                                throwExceptionInside("trying to evaluate generator stack",
                                                     p.getOngoingEnvironments(),
                                                     tr);
                                new Exception().printStackTrace();
                                if (SystemProperties.getIntProperty("exitOnException", 0) == 1) System.exit(1);
        ...
        factories.add(new iDelegateForReturnValue() {
            public
            Delegate delegateForReturnValue(float time,
                                            Promise p,
                                            boolean forwards,
                                            Object ret,
                                            final boolean noDefaultBackwards) {
                if (ret instanceof PyDictionary) {
                    ...
                    final Delegate beginning = delegateForReturnValue_impl(time,
                                                                           p,
                                                                           forwards,
                                                                           t.__finditem__(Py.java2py("start")),
                                                                           noDefaultBackwards);
                    final Delegate middle = delegateForReturnValue_impl(time,
                                                                        p,
                                                                        forwards,
                                                                        t.__finditem__(Py.java2py("continue")),
                                                                        noDefaultBackwards);
                    final Delegate end = delegateForReturnValue_impl(time,
                                                                     p,
                                                                     forwards,
                                                                     t.__finditem__(Py.java2py("end")),
                                                                     noDefaultBackwards);
                    ...
                    return new Delegate() {
                        ...
                        void continueToBeActive(float t, Promise p, boolean forwards) {
                            if (p.isPaused()) return;
                            if (!hasStarted) {
                                if (middle != null) middle.start(t, p, forwards);
                                hasStarted = true;
                            }
                            if (middle != null) middle.continueToBeActive(t, p, forwards);
                        }

                        public
                        void jumpStop(float t, Promise p, boolean forwards) {
                            if (hasStarted) {
                                if (middle != null) middle.jumpStop(t, p, forwards);
                            }
                            if (end != null) end.jumpStop(t, p, forwards);
                        }
                        ...
                        public
                        void startAndStop(float t, Promise p, boolean forwards) {
                            if (beginning != null) beginning.startAndStop(t, p, forwards);
                            if (end != null) end.startAndStop(t, p, forwards);
                        }

                        public
                        void stop(float t, Promise p, boolean forwards) {
                            if (hasStarted) {
                                if (middle != null) middle.stop(t, p, forwards);
                                hasStarted = false;
                            }
                            if (end != null) {
        ...
        factories.add(new iDelegateForReturnValue() {
            ...
            Delegate delegateForReturnValue(float time,
                ...
                if (ret instanceof PyTuple) {
                    ...
                    final Delegate beginning =
                            delegateForReturnValue_impl(time, p, forwards, t.__getitem__(0), noDefaultBackwards);
                    final Delegate middle =
                            delegateForReturnValue_impl(time, p, forwards, t.__getitem__(1 % num), noDefaultBackwards);
                    final Delegate end =
                            delegateForReturnValue_impl(time, p, forwards, t.__getitem__(2 % num), noDefaultBackwards);
    ...
    public static
    Delegate delegateForReturnValue_impl(float t,
                                         Promise p,
                                         boolean forwards,
                                         Object ret,
                                         final boolean noDefaultBackwards) {
