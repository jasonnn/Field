...
public
class HyperlinkedErrorMessage {

    public
    HyperlinkedErrorMessage() {
    }
    ...
    public
    void filterOutput(String output, DefaultStyledDocument outputTo, MutableAttributeSet es)
        ...
        try {
            ...
            while (found) {
                ...
                outputTo.insertString(outputTo.getEndPosition().getOffset() - 1,
                                      "((printed component))",
    ...
    private
    JComponent makeButton(final String uidDesc, final String line) {
