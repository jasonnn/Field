...
@Woven
public
class HistoryExplorerHG {

    public
    class DiffSetVertical {
        ...
        public
        DiffSetVertical(Diff.Change head, String[] left, String[] right, long leftVersion, long rightVersion) {
    ...
    class VersionNode extends field.math.graph.NodeImpl<VersionNode> {
        ...
        @Override
        public
        List<VersionNode> getParents() {
            if (previous == null) return Collections.EMPTY_LIST;
    ...
    public
    HistoryExplorerHG(String repositoryRoot, String sheetName) {
    ...
    public
    Map<VersionNode, DiffSetVertical> buildCompleteDiffHistory(VersionNode root) {
        return buildCompleteDiffHistory(root, null);
    }

    public
    Map<VersionNode, DiffSetVertical> buildCompleteDiffHistory(VersionNode root, final String head) {
...
//				;//System.out.println(" comparing\n"+left+"("+leftVersion+")\n"+right+"("+n.revision+")");
                ...
                DiffSetVertical vert =
                        new DiffSetVertical(change, left.split("\n"), right.split("\n"), leftVersion, rightVersion);
...
//		}
    ...
    public
    Object getVersionProperty(long revision, String path, VisualElementProperty property) {
