...
class Versionings {
    ...
    class Path {
        ...
        public
        Path(String sheet, String uid, String propertyName) {
            this.sheet = sheet;
            this.uid = uid;
        ...
        boolean equals(Object obj) {
            ...
            return ((Path) obj).sheet.equals(sheet)
                   && ((Path) obj).uid.equals(uid)
                   && ((Path) obj).propertyName.equals(propertyName);
        }

        public
        boolean isSameElementAs(Path path) {
