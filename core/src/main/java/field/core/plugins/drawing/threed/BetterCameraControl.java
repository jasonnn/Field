...
class BetterCameraControl implements IUpdateable {
    ...
    public
    BetterCameraControl(BasicSceneList list) {
        this.list = list;
    }
    ...
    public
    void transitionToState(final State in, final BasicCamera on, final int over) {
    ...
    public
    State lookAtMiddleOfVisible(State in) {
    ...
    public
    State lookAtMiddleOfVisibleDepth(State in) {
    ...
    State frameAll(State in) {
        ...
        for (iGeometry g : allMeshes) {
            ...
            int step = 1;
            if (n > 1000) step = (int) (Math.log10(n) - 1);
    ...
    public
    Pair<Vector3, Vector3> aabb(State in) {
    ...
    public
    Pair<Vector3, Vector3> aabbVisible(State in) {
        Vector3 min = new Vector3(Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY);
        Vector3 max = new Vector3(Float.NEGATIVE_INFINITY, Float.NEGATIVE_INFINITY, Float.NEGATIVE_INFINITY);
    ...
    public
    Vector3 centerVisible(State in) {
