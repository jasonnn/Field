...
public
class VerticalLeftToLeftAlign extends PointOffering {
    ...
    public
    VerticalLeftToLeftAlign(float baseScore) {
    ...
    iDrawable newDrawableFor(float bestScore,
        ...
        return new BaseDrawable(element.getUniqueID(), bestScore, originalPoint, best) {
            ...
            @Override
            protected
            void drawWithOpacity(OfferedAlignment al, float alpha) {
                ...
                outline.getInput()
                       .lineTo((float) (currentNewRect.x + currentNewRect.w),
                               (float) (currentNewRect.y + currentNewRect.h));
                ...
                Vector3 v2 = new Quaternion().set(new AxisAngle(new Vector3(0, 0, 1), (float) (Math.PI / 2)))
                                             .rotateVector(new Vector3(v));
                Vector3 v3 = new Quaternion().set(new AxisAngle(new Vector3(0, 0, 1), (float) (Math.PI / 2)))
                                             .rotateVector(new Vector3(v));
