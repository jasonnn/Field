...
class Small3dLineEmitter_long {
    ...
    public
    Small3dLineEmitter_long setCanEmitCubic(boolean canEmitCubic) {
    ...
    public
    void flattenCubicFrame(Vector3 a,
                           Vector3 c1,
                           Vector3 c2,
                           Vector3 b,
                           List<Object> propertiesA,
                           List<Object> propertiesB,
                           Dict globalProperties,
                           iLinearGraphicsContext context,
                           int n) {
    ...
    public
    void flattenCubicFrame(Vector2 a,
                           Vector2 c1,
                           Vector2 c2,
                           Vector2 b,
                           List<Object> propertiesA,
        ...
        flattenCubicFrame(new Vector3(a.x, a.y, depthFor(propertiesA)),
                          new Vector3(c1.x, c1.y, control1for(propertiesB)),
                          new Vector3(c2.x, c2.y, control2for(propertiesB)),
                          new Vector3(b.x, b.y, depthFor(propertiesB)),
                          propertiesA,
                          propertiesB,
                          globalProperties,
                          context,
    ...
    public
    void flattenLinearFrame(Vector3 a,
                            Vector3 b,
                            List<Object> propertiesA,
                            List<Object> propertiesB,
                            Dict properties,
    ...
    public
    void flattenLinearFrame(Vector2 a,
                            Vector2 b,
                            List<Object> propertiesA,
                            List<Object> propertiesB,
                            Dict properties,
        ...
        flattenLinearFrame(new Vector3(a.x, a.y, depthFor(propertiesA)),
                           new Vector3(b.x, b.y, depthFor(propertiesB)),
                           propertiesA,
                           propertiesB,
                           properties,
    ...
    float flatnessFor(Vector3 a,
        ...
        float geometric1 = c1 == null
                           ? 0
                           : (float) CubicCurve2D.getFlatness(a.x, a.y, c1.x, c1.y, c2.x, c2.y, b.x, b.y)
                             * globalGeometricScale;
        float geometric2 = c1 == null
                           ? 0
                           : (float) CubicCurve2D.getFlatness(a.x, a.z, c1.x, c1.z, c2.x, c2.z, b.x, b.z)
                             * globalGeometricScale;
        float geometric3 = c1 == null
                           ? 0
                           : (float) CubicCurve2D.getFlatness(a.z, a.y, c1.z, c1.y, c2.z, c2.y, b.z, b.y)
                             * globalGeometricScale;
    ...
    private
    float propertyFlatness(List<Object> propertiesA, List<Object> propertiesB) {
    ...
    public
    List<Object> packet(Event event) {
