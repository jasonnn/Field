...
public
class VerticalCenterToVerticalCenter extends VerticalLeftToLeftAlign {

    public static
    class Resize extends VerticalCenterToVerticalCenter {
        public
    ...
    public
    VerticalCenterToVerticalCenter(float baseScore) {
        super(baseScore);
    }
