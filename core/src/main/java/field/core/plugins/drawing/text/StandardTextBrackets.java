...
class StandardTextBrackets {
    ...
    class South implements iBracketFactory {
        ...
        public
        South(float underline, float extraspace, float footsize) {
        ...
        List<BracketElement> getBracketFor(AdvancedTextToCachedLine layout) {
            ...
            return Arrays.asList(foot1, line, foot2);
    ...
    class North implements iBracketFactory {
        ...
        public
        North(float overline, float extraspace, float footsize) {
    ...
    class East implements iBracketFactory {
        ...
        public
        East(float overline, float underline, float extraspace, float footsize) {
            this.overline = overline;
            this.underline = underline;
            this.extraspace = extraspace;
            this.footsize = footsize;
    ...
    class West implements iBracketFactory {
        ...
        public
        West(float overline, float underline, float extraspace, float footsize) {
            this.overline = overline;
            this.underline = underline;
            this.extraspace = extraspace;
            this.footsize = footsize;
        ...
        List<BracketElement> getBracketFor(AdvancedTextToCachedLine layout) {
            ...
            Vector2 bottom = new Vector2(Math.max(rectTop.x + rectTop.w, rectBottom.x + rectBottom.w),
                                         rectBottom.y + rectBottom.h);
    ...
    class NorthEast implements iBracketFactory {
        ...
        public
        NorthEast(float overline, float underline, float extraspace, float footsize) {
            this.overline = overline;
            this.underline = underline;
            this.extraspace = extraspace;
            this.footsize = footsize;
        ...
        List<BracketElement> getBracketFor(AdvancedTextToCachedLine layout) {
            ...
            return Arrays.asList(foot1, line1, corner, line2, foot2);
    ...
    class NorthWest implements iBracketFactory {
        ...
        public
        NorthWest(float overline, float underline, float extraspace, float footsize) {
            this.overline = overline;
            this.underline = underline;
            this.extraspace = extraspace;
            this.footsize = footsize;
    ...
    class SouthWest implements iBracketFactory {
        ...
        public
        SouthWest(float overline, float underline, float extraspace, float footsize) {
            this.overline = overline;
            this.underline = underline;
            this.extraspace = extraspace;
            this.footsize = footsize;
    ...
    class SouthEast implements iBracketFactory {
        ...
        public
        SouthEast(float overline, float underline, float extraspace, float footsize) {
            this.overline = overline;
            this.underline = underline;
            this.extraspace = extraspace;
            this.footsize = footsize;
    ...
    public static
    iBracketFactory[] connectTwoTextElements(float extraSpace,
                                             float feetSize,
                                             float proximity,
                                             AdvancedTextToCachedLine from,
                                             AdvancedTextToCachedLine to) {
        ArrayList<CachedLine> q = new ArrayList<CachedLine>();

        iBracketFactory[] factories = {new North(proximity, extraSpace, feetSize),
                                       new South(proximity, extraSpace, feetSize),
                                       new West(proximity, proximity, extraSpace, feetSize),
                                       new East(proximity, proximity, extraSpace, feetSize),
                                       new NorthEast(proximity, proximity, extraSpace, feetSize),
                                       new NorthWest(proximity, proximity, extraSpace, feetSize),
                                       new SouthWest(proximity, proximity, extraSpace, feetSize),
                                       new SouthEast(proximity, proximity, extraSpace, feetSize)};
        ...
        for (int x = 0; x < factories.length; x++) {
            ...
            for (int y = 0; y < factories.length; y++) {
                ...
                Vector2 cheap2 =
                        LineUtils.getPointOnLine(line, d1 - 0.25f).sub(LineUtils.getPointOnLine(line, d1 + 0.25f));
    ...
    public static
    iBracketFactory connectOneTextElement(float extraSpace,
                                          float feetSize,
                                          float proximity,
                                          AdvancedTextToCachedLine from,
                                          Vector2 to) {
