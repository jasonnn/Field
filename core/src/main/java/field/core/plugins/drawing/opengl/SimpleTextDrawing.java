...
public
class SimpleTextDrawing {

    public
    class DrawsText implements iDrawingAcceptor<CachedLine> {

        private final BaseGLGraphicsContext context;

        public
        DrawsText(BaseGLGraphicsContext context) {
        ...
        DrawingResult accept(List<iDynamicMesh> soFar, final CachedLine line, final Dict properties) {
            ...
            DrawingResult result = new DrawingResult(DrawingResultCode.cont, new IUpdateable() {
                ...
                void update() {
                    ...
                    for (Event e : line.events) {
                        if (e.attributes != null && e.attributes.get(iLinearGraphicsContext.text_v) != null) {
                            ...
                            if (zz == null) z = 0.5f;
                            else if (zz instanceof Number) z = ((Number) zz).floatValue();
                            else if (zz instanceof Vector3) z = ((Vector3) zz).z;
                            ...
                            render(at,
                                   s,
                                   e.attributes.get(iLinearGraphicsContext.font_v),
                                   e.attributes.get(iLinearGraphicsContext.textIsBlured_v),
                                   colorFor(e),
                                   opacityMul,
                                   f.floatValue(),
                                   ts,
                ...
                protected
                void render(Vector2 destination,
                            String string,
                            java.awt.Font font,
                            Boolean blur,
                            Vector4 colorFor,
                    ...
                    if (font == null) font = new Font(Constants.defaultFont, Font.PLAIN, 1).deriveFont(11 * scale);
                    else font = font.deriveFont(font.getSize() * scale);
                    ...
                    if (r == null) {
                        ...
                        if (string.startsWith("<html>")) {
                            ...
                            if (blur != null && blur) r.resetTextDropShadow(string,
                                                                            1,
                                                                            1,
                                                                            1,
                                                                            0,
                    ...
                    if (alignment < 0) r.setJustification(TextSystem.Justification.right);
                    else if (alignment > 0) r.setJustification(TextSystem.Justification.left);
                    else r.setJustification(TextSystem.Justification.center);
                    r.setTotalScale(totalScale);
                    r.setZ(z);

                    Quaternion rr = new Quaternion();
                    if (rotation instanceof Number) rr = new Quaternion(((Number) rotation).doubleValue());
                    else if (rotation instanceof Quaternion) rr = (Quaternion) rotation;
...
//						BasicGLSLangProgram.currentProgram.debugPrintUniforms();
        ...
        public LinkedHashMap<Triple<String, Font, String>, TextSystem.RectangularLabel> cache =
                new LinkedHashMap<Triple<String, Font, String>, TextSystem.RectangularLabel>() {
                    @Override
                    protected
                    boolean removeEldestEntry(java.util.Map.Entry<Triple<String, Font, String>, RectangularLabel> eldest) {
    ...
    public
    class DrawsMultilineText implements iDrawingAcceptor<CachedLine> {

        private final BaseGLGraphicsContext context;

        public
        DrawsMultilineText(BaseGLGraphicsContext context) {
            this.context = context;
        }
            ...
            DrawingResult result = new DrawingResult(DrawingResultCode.cont, new IUpdateable() {
                ...
                void update() {
                    ...
                    for (Event e : line.events) {
                        if (e.attributes != null && e.attributes.get(iLinearGraphicsContext.text_v) != null) {
                            ...
                            if (ww instanceof Number) w = ((Number) ww).floatValue();
                            else if (ww instanceof Vector3) w = ((Vector3) ww).z;
                ...
                void render(Vector2 destination,
                    ...
                    if (r == null) {
                        ...
                        r.resetTextAsLabelWithMaxSize(string,
                                                      1,
                                                      1,
                                                      1,
                                                      0,
    ...
    public
    SimpleTextDrawing(boolean useRect) {
    ...
    public
    SimpleTextDrawing setForceScale(Float forceScale) {
    ...
    public
    void installInto(BaseGLGraphicsContext installedContext) {
