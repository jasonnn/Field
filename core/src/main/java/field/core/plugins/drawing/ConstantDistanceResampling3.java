 ...
 */
public
class ConstantDistanceResampling3 {
    ...
    public
    ConstantDistanceResampling3(float minResolution, int maxSubdiv) {
...
inner:
    ...
    protected static
    void convertStreamToSmoothSpline(List<Vector3> stream, iLine resampledIn) {
    ...
    public
    void drawInto(CachedLine line, Small3dLineEmitter_long lineEmitter, CachedLine in) {
