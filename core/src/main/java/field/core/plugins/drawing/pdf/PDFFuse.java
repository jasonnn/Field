...
public class PDFFuse {
    ...
    public void addImage(String filename, Rect intoRect) throws DocumentException, IOException {
    ...
    public void addImageMultiply(String filename, Rect intoRect, float opacity) throws DocumentException, IOException {
        Image pdfimage = Image.getInstance(filename);
		over.saveState();
    ...
    public void addImageScreen(String filename, Rect intoRect, float opacity) throws DocumentException, IOException {
        Image pdfimage = Image.getInstance(filename);
		over.saveState();
		PdfGState gs1 = new PdfGState();
		gs1.setFillOpacity(opacity);
    ...
    public void addImageScreen(String filename, Rect intoRect, float opacity, float rotation) throws DocumentException, IOException {
        Image pdfimage = Image.getInstance(filename);
		over.saveState();
		PdfGState gs1 = new PdfGState();
		gs1.setFillOpacity(opacity);
