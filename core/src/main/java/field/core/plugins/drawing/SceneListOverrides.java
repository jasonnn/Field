...
public
class SceneListOverrides extends DefaultOverride {
            ...
            try {
                ...
                if (s != null) {
                    ...
                    if (onDemandCamera == null) {
                        ...
                        ball = new ArcBall(onDemandCamera,
                            ...
                            public
                            void keyPressed(field.core.windowing.GLComponentWindow.ComponentContainer inside,
                                            Event arg0) {
                                if (isSelected()) super.keyPressed(inside, arg0);
                            }
                        };
                    ...
                    onDemandCamera.setViewport((int) topLeft.x,
                                               h - (int) bottomRight.y,
