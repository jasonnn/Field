...
class SimpleArrows {
    ...
    public
    CachedLine arrowForMiddle(CachedLine c, float size, float width) {
        return arrowFor(c, 0.5f, size, width);
    }

    public
    CachedLine arrowFor(CachedLine c, float along, float size, float width) {
    ...
    public
    CachedLine arrowForEnd(CachedLine c, float distanceBack, float size, float width) {
