...
public
class HorizontalBottomToBottomAlign extends VerticalLeftToLeftAlign {

    public static
    class Resize extends HorizontalBottomToBottomAlign {
        public
    ...
    public
    HorizontalBottomToBottomAlign(float baseScore) {
        super(baseScore);
    }
