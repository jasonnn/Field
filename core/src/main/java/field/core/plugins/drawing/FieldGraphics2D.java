...
public
class FieldGraphics2D extends Graphics2D {
    ...
    void draw(Shape s) {
        ...
        if (color != null) p.put(iLinearGraphicsContext.strokeColor,
                                 new Vector4(color.getRed() / 255f,
                                             color.getGreen() / 255f,
                                             color.getBlue() / 255f,
                                             color.getAlpha() / 255f));
    ...
    void fill(Shape s) {
        ...
        if (color != null) p.put(iLinearGraphicsContext.fillColor,
                                 new Vector4(color.getRed() / 255f,
                                             color.getGreen() / 255f,
                                             color.getBlue() / 255f,
                                             color.getAlpha() / 255f));
