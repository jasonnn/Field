...
public
class LineInteraction3d extends LineInteraction {

    protected final BasicCamera camera;
    protected Projector projector;

    public
    LineInteraction3d(BasicCamera camera) {
        this.camera = camera;
    }
    ...
    void setAllCachedLines(Collection<CachedLine> c) {
        ...
        if ((this.projector == null) || !this.projector.equals(projector)) intersectionCache.clear();
