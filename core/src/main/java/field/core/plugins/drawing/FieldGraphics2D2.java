...
public
class FieldGraphics2D2 extends AbstractGraphics2D {
...
//		}
        ...
        if (gc.stroke != null) {
            ...
            if (strokeQuality && !gc.stroke.equals(defaultStroke)) {
                ...
                if (!needsTransform) gc.transform = new AffineTransform();
...
//				;//System.out.println(" -- drawing line with stroke <"+gc.stroke+">");
        ...
        if (gc.getColor() != null) p.put(iLinearGraphicsContext.strokeColor,
                                         new Vector4(gc.getColor().getRed() / 255f,
                                                     gc.getColor().getGreen() / 255f,
                                                     gc.getColor().getBlue() / 255f,
                                                     gc.getColor().getAlpha() / 255f));
...
//		}
        ...
        if (gc.getColor() != null) p.put(iLinearGraphicsContext.fillColor,
                                         new Vector4(gc.getColor().getRed() / 255f,
                                                     gc.getColor().getGreen() / 255f,
                                                     gc.getColor().getBlue() / 255f,
                                                     gc.getColor().getAlpha() / 255f));
    ...
    void drawString(String arg0, float arg1, float arg2) {
        ...
        if (gc.getColor() != null) {
            p.put(iLinearGraphicsContext.fillColor,
                  new Vector4(gc.getColor().getRed() / 255f,
                              gc.getColor().getGreen() / 255f,
                              gc.getColor().getBlue() / 255f,
                              gc.getColor().getAlpha() / 255f));
            p.put(iLinearGraphicsContext.strokeColor,
                  new Vector4(gc.getColor().getRed() / 255f,
                              gc.getColor().getGreen() / 255f,
                              gc.getColor().getBlue() / 255f,
                              0.65f * gc.getColor().getAlpha() / 255f));
        }
    ...
    @Override
    public
    boolean drawImage(Image arg0, int arg1, int arg2, ImageObserver arg3) {
        return false;
    }

    @Override
    public
    boolean drawImage(Image arg0, int arg1, int arg2, int arg3, int arg4, ImageObserver arg5) {
        return false;
    }
