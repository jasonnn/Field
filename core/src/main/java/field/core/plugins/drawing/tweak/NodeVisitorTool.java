...
public
class NodeVisitorTool extends BaseTool {

    private final Class<?> wrClass;

    public
    class ApplyToolCoordinateChange implements iCoordDesc {
        public
        iResult describe(List<CachedLine> index, List<SelectedVertex> claimed, MouseInfo mi) {
            ...
            if ((fmask[0] == 1) && (fmask[1] == 1) && (fmask[2] == 1)) fmask = null;
