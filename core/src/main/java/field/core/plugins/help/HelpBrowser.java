...
@Woven
public
class HelpBrowser extends BaseSimplePlugin {

    public static final VisualElementProperty<HelpBrowser> helpBrowser =
            new VisualElementProperty<HelpBrowser>("helpBrowser");

    public static final VisualElementProperty<String> documentation =
            new VisualElementProperty<String>("documentation");
    ...
    static String preamble =
            "<html><head> <script type=\"text/javascript\" src=\"http://localhost:10010/documentation/scripts/mootools.js\"></script><style type=\"text/css\">\n"
            + "body\n"
            + "{\n"
    ...
    void registeredWith(final IVisualElement root) {
        ...
        try {
            server = new NanoHTTPD(10010) {
                public
                Response serve(String uri, String method, java.util.Properties header, java.util.Properties parms) {
                    ...
                    try {
                        ...
                        if (uri.contains("images/")) {
                            ...
                            String ref = ObjectToMarkDown.browsed.get(s);
        ...
        Color backgroundColor = ToolBarFolder.background;
        ...
        try {
            ...
            browser.addOpenWindowListener(new OpenWindowListener() {
                ...
                void open(WindowEvent event) {
                    Shell shell = new Shell(Launcher.display);
    ...
    void setText(String x) {
        if (x == null || "null".equals(x)) return;
        if ("<p>null</p>".equals(x.trim())) return;
        ...
        if (found != null) {
            ...
            try {
                ...
                while (w.hasNext()) {
                    ...
                    if (val != null) PythonInterface.getPythonInterface().setVariable(name, val);
                }
            }
        }
        else {
    ...
    protected
    java.io.InputStream findAndInvoke(String replace, Properties parms) {
        Object m = ObjectToMarkDown.invokeMap.get(replace);
        if (m == null) m = PythonInterface.getPythonInterface().getVariable(replace);
        ...
        if (u == null) return new ReaderInputStream(new StringReader("didn't know how to invoke object " + m));
