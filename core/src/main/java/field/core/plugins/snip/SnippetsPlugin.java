...
@Woven
public
class SnippetsPlugin extends BaseSimplePlugin {

    public static final VisualElementProperty<SnippetsPlugin> snippets =
    ...
    class Snippet extends NodeImpl<Snippet> implements iProvidesSearchTerms,
        ...
        public
        Snippet(String text, String annotation, String subgroupname) {
            this.text = text;
        ...
        String getSelectionText() {
            if (annotation != null && annotation.isEmpty()) return text;
            else return text.split("\n")[0];
        }

        public
        void addChildFirst(Snippet newChild) {
    ...
    void registeredWith(final iVisualElement root) {
        ...
        snippetUI = new SelectionSetUI("icons/right_quote_32x32.png", parent) {
            ...
            protected
            void selectionChanged(org.eclipse.swt.widgets.TreeItem[] selection) {
    ...
    @NextUpdate(delay = 1)
    protected
    void searchTextUpdated(KeyEvent e) {
        rebuild();
    }
    ...
    public
    void addText(String text, String annotation, String[] subannotation, String groupname) {
        text = text.trim();
    ...
    public
    void addText(String text, String annotation, String groupname) {
        text = text.trim();
        Snippet s = new Snippet(text, annotation, groupname);
    ...
    protected
    Snippet search(Snippet root, String text) {
