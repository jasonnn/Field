...
class TreeBrowserDispatch {
    ...
    static {
        ...
        childrenOf.register(Object.class, "sc", new IFunction<Object, Object>() {
            ...
            private
            Object labelledList(final String string, final List<Run> ff) {
    ...
    public
    void register(Class c, PyFunction f) {
        List<PythonCallableMap> m = dispatch.getList(c);
        if (m == null) {
            dispatch.put(c, m = new ArrayList<PythonCallableMap>());
        }
    ...
    public
    List<Object> gather(Object... args) {
