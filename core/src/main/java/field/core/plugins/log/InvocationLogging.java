...
class InvocationLogging {
    ...
    public
    PyObject linkGetAttr(PyObject in, String name, boolean isRoot, String path, PyObject parent) {
...
//			if (in instanceof PyJavaInstance) 
            if (in instanceof PyObject) {
                ...
                if (er != null) er.recover(j, name, value.__tojava__(Object.class));
                return;
            }
        }
