...
class ChangeBlending {
    ...
    public
    void reapplyChangeSetPartially(ArrayList<SimpleChange> set, float amount) {
...
//	}
    ...
    public
    ArrayList<SimpleChange> createBlendedSet(ArrayList<SimpleChange> a, ArrayList<SimpleChange> b, float amount) {
        ArrayList<SimpleChange> ret = new ArrayList<SimpleChange>();
        LinkedHashMap<String, SimpleChange> left = new LinkedHashMap<String, SimpleChange>();
    ...
    public
    void addBlender(iBlendSupport s) {
        blenders.add(s);
    }
    ...
    ChangeBlending() {
        ...
        blenders.add(new iBlendSupport<Number>() {
            ...
            public
            Number blend(Number a, Number b, float alpha) {
    ...
    protected
    Object getBlended(Object previousValue, Object value, float amount) {
