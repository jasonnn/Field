...
class SimpleLogging {
    ...
    static {
        System.setErr(new PrintStream(System.err) {
            ...
            void write(byte[] buf, int off, int len) {
                ...
                if (Logging.logging == null) return;
        ...
        Launcher.getLauncher().addExceptionHandler(new iExceptionHandler() {
            ...
            public
            boolean handle(final Throwable t) {
                if (Logging.logging != null) Logging.logging.addEvent(new iLoggingEvent() {
                    ...
                    public
                    String getLongDescription(Throwable t) {
                        ...
                        if (cc != null) return m + er + "<br><br><i>cause</i><br>" + getLongDescription(cc);
                        return m + er;
                    }
    ...
    protected static
    void flushThisLine(final StringBuffer buffer) {
        if (Logging.logging == null) return;
        try {
            ...
            else if (!buffer.toString().toLowerCase().startsWith("#message#")) return;
    ...
    private static
    void flushNow(final String s, final Exception e) {
        ...
        Logging.logging.addEvent(new iLoggingEvent() {
            ...
            public
            String getTextDescription() {
                if (e != null) return "<html><font bgcolor=#664444><b>error" + s.substring("#error#".length()) + "</b>";
                return "<html>" + s;
            }
