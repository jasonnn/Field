...
class SelectionSetUI {
     ...
     */
    public
    SelectionSetUI(String name, ToolBarFolder folder) {
        frameName = name;
        ...
        target.addDropListener(new DropTargetListener() {
            ...
            @Override
            public
            void dropAccept(DropTargetEvent arg0) {
            ...
            @Override
            public
            void drop(DropTargetEvent arg0) {
            ...
            @Override
            public
            void dragOver(DropTargetEvent arg0) {
            ...
            @Override
            public
            void dragOperationChanged(DropTargetEvent arg0) {
            ...
            @Override
            public
            void dragLeave(DropTargetEvent arg0) {

            }

            @Override
            public
            void dragEnter(DropTargetEvent arg0) {
    ...
    // TODO selectionSet
    protected
    void doubleClickRow(TreeItem item) {
    }
    ...
    // TODO selectionSEt
    public
    void setWaterText(String string) {
