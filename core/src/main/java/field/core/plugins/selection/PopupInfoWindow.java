...
class PopupInfoWindow {
    ...
    public
    void becomeVisible(int x, int y, int width, int height, String contents) {
        visibleVotes++;
    ...
    public
    PopupInfoWindow initialize(String title) {
                ...
                if (fader == null) {
                    Launcher.getLauncher().registerUpdateable(fader = new IUpdateable() {
                        ...
                        void update() {
                            ...
                            if (opacity > 1e-2) doSetVisible(true);
                            else doSetVisible(false);
                        }
                    });
                    fader.update();
                }
        ...
        drawerFrame.addWindowFocusListener(new WindowFocusListener() {
            ...
            void windowLostFocus(WindowEvent e) {
                if (visibleVotes == 0) {
                    if (drawerFrame.isVisible()) drawerFrame.setVisible(false);
                }
            }
        });
    ...
    JPanel getDrawer() {
        if (drawer == null) {
            ...
            drawer.setBorder(new BevelBorder(BevelBorder.LOWERED,
