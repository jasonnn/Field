...
class ClSimplexSolver extends ClTableau {
    ...
    public final
    ClSimplexSolver addLowerBound(ClAbstractVariable v, double lower) throws ExCLRequiredFailure, ExCLInternalError {
    ...
    // Convenience function for creating a linear inequality constraint
    public final
    ClSimplexSolver addUpperBound(ClAbstractVariable v, double upper) throws ExCLRequiredFailure, ExCLInternalError {
    ...
    public final
    ClSimplexSolver addConstraint(ClConstraint cn) throws ExCLRequiredFailure, ExCLInternalError {
        ...
        if (cn.isEditConstraint()) {
            ...
            _editVarMap.put(cnEdit.variable(),
                            new ClEditInfo(cnEdit, clvEplus, clvEminus, prevEConstant.doubleValue(), i));
        }
    ...
    public final
    boolean addConstraintNoException(ClConstraint cn) throws ExCLInternalError {
    ...
    public final
    ClSimplexSolver addEditVar(ClVariable v, ClStrength strength) throws ExCLInternalError {
        try {
    ...
    public final
    ClSimplexSolver addEditVar(ClVariable v) throws ExCLInternalError {
        return addEditVar(v, ClStrength.strong);
    }

    // Remove the edit constraint previously added for variable v
    public final
    ClSimplexSolver removeEditVar(ClVariable v) throws ExCLInternalError, ExCLConstraintNotFound {
    ...
    public final
    ClSimplexSolver beginEdit() throws ExCLInternalError {
    ...
    public final
    ClSimplexSolver endEdit() throws ExCLInternalError {
        _assert(!_editVarMap.isEmpty(), "_editVarMap.size() > 0");
        resolve();
        _stkCedcns.pop();
    ...
    // that were added
    public final
    ClSimplexSolver removeAllEditVars() throws ExCLInternalError {
        return removeEditVarsTo(0);
    }

    // remove the last added edit vars to leave only n edit vars left
    public final
    ClSimplexSolver removeEditVarsTo(int n) throws ExCLInternalError {
        try {
    ...
    public final
    ClSimplexSolver addPointStays(Vector listOfPoints) throws ExCLRequiredFailure, ExCLInternalError {
    ...
    public final
    ClSimplexSolver addPointStay(ClVariable vx, ClVariable vy) throws ExCLRequiredFailure, ExCLInternalError {
        addPointStay(vx, vy, 1.0);
        return this;
    }

    public final
    ClSimplexSolver addPointStay(ClPoint clp, double weight) throws ExCLRequiredFailure, ExCLInternalError {
    ...
    public final
    ClSimplexSolver addPointStay(ClPoint clp) throws ExCLRequiredFailure, ExCLInternalError {
    ...
    public final
    ClSimplexSolver addStay(ClVariable v, ClStrength strength) throws ExCLRequiredFailure, ExCLInternalError {
    ...
    public final
    ClSimplexSolver addStay(ClVariable v) throws ExCLRequiredFailure, ExCLInternalError {
    ...
    public final
    ClSimplexSolver removeConstraint(ClConstraint cn) throws ExCLConstraintNotFound, ExCLInternalError {
            ...
            for (Enumeration<Object> e = eVars.elements(); e.hasMoreElements(); ) {
                ...
                if (expr == null) {
                    ...
                    zRow.addExpression(expr,
                                       -cn.weight() * cn.strength().symbolicWeight().asDouble(),
                                       _objective,
                                       this);
                }
            }
    ...
    public final
    void resolve(Vector<ClDouble> newEditConstants) throws ExCLInternalError {
        ...
        for (Enumeration<ClVariable> e = _editVarMap.keys(); e.hasMoreElements(); ) {
            ...
            int i = cei.Index();
            try {
                if (i < newEditConstants.size()) suggestValue(v, newEditConstants.elementAt(i).doubleValue());
            } catch (ExCLError err) {
    ...
    public final
    void resolve(double x, double y) throws ExCLInternalError {
    ...
    public final
    void resolve() throws ExCLInternalError {
    ...
    public final
    ClSimplexSolver suggestValue(ClVariable v, double x) throws ExCLError {
    ...
    public final
    ClSimplexSolver setAutosolve(boolean f) {
    ...
    // values
    public final
    ClSimplexSolver solve() throws ExCLInternalError {
        if (_fNeedsSolving) {
            optimize(_objective);
            setExternalVariables();
        }
    ...
    public
    ClSimplexSolver setEditedValue(ClVariable v, double n) throws ExCLInternalError {
    ...
    public final
    boolean FContainsVariable(ClVariable v) throws ExCLInternalError {
        return columnsHasKey(v) || (rowExpression(v) != null);
    }

    public
    ClSimplexSolver addVar(ClVariable v) throws ExCLInternalError {
        if (!FContainsVariable(v)) {
            try {
                addStay(v);
            } catch (ExCLRequiredFailure e) {
    ...
    public
    Hashtable<ClConstraint, ClAbstractVariable> getConstraintMap() {
        return _markerVars;
    }
    ...
    protected final
    void addWithArtificialVariable(ClLinearExpression expr) throws ExCLRequiredFailure, ExCLInternalError {
    ...
    // false if not.
    protected final
    boolean tryAddingDirectly(ClLinearExpression expr) throws ExCLRequiredFailure {
    ...
    protected final
    ClAbstractVariable chooseSubject(ClLinearExpression expr) throws ExCLRequiredFailure {
    ...
    protected final
    void dualOptimize() throws ExCLInternalError {
    ...
    protected final
    ClLinearExpression newExpression(ClConstraint cn, Vector<ClSlackVariable> eplus_eminus, ClDouble prevEConstant) {
        ...
        for (Map.Entry<ClAbstractVariable, ClDouble> clAbstractVariableClDoubleEntry : cnTerms.entrySet()) {
            ...
            if (e == null) expr.addVariable(clAbstractVariableClDoubleEntry.getKey(), c);
    ...
    // be feasible.)
    protected final
    void optimize(ClObjectiveVariable zVar) throws ExCLInternalError {
    ...
    protected final
    void pivot(ClAbstractVariable entryVar, ClAbstractVariable exitVar) throws ExCLInternalError {
    ...
    void resetStayConstants() {
        ...
        for (int i = 0; i < _stayPlusErrorVars.size(); i++) {
            ...
            if (expr == null) expr = rowExpression(_stayMinusErrorVars.elementAt(i));
    ...
    void insertErrorVar(ClConstraint cn, ClAbstractVariable var) {
        ...
        if (cnset == null) _errorVars.put(cn, cnset = new Set());
        cnset.insert(var);
    }
