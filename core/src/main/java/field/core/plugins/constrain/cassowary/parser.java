 ...
 */
public
class parser extends lr_parser {
    /**
     * Default constructor.
     */
    public
    ...
    protected static final short[][] _production_table =
            unpackFromStrings(new String[]{"\000\016\000\002\003\003\000\002\002\004\000\002\003"
    ...
    protected static final short[][] _action_table =
            unpackFromStrings(new String[]{"\000\033\000\012\010\007\014\011\016\005\017\013\001"
    ...
    protected static final short[][] _reduce_table =
            unpackFromStrings(new String[]{"\000\033\000\012\003\007\004\003\005\005\006\011\001"
    ...
    @Override
    public
    Symbol do_action(int act_num, lr_parser parser, java.util.Stack stack, int top) throws java.lang.Exception {
    ...
    Symbol CUP$parser$do_action(int CUP$parser$act_num,
		...
		/*. . . . . . . . . . . . . . . . . . . .*/
            case 13: // expr ::= LPAREN expr RPAREN
            {
                ...
                RESULT = a;
                CUP$parser$result = new Symbol(4/*expr*/,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 2)).left,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right,
                                               RESULT);
            }
            ...
            case 7: // expr ::= VARIABLE
            {
                ...
                CUP$parser$result = new Symbol(4/*expr*/,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).left,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right,
                                               RESULT);
            }
            return CUP$parser$result;
            ...
            case 5: // inequality ::= expr LEQ expr
            {
                ...
                CUP$parser$result = new Symbol(3/*inequality*/,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 2)).left,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right,
                                               RESULT);
            }
            ...
            case 3: // equation ::= expr EQ expr
            {
                ...
                CUP$parser$result = new Symbol(2/*equation*/,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 2)).left,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right,
                                               RESULT);
            }
            ...
            case 2: // constraint ::= inequality
            {
                ...
                Object a = ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).value;
                RESULT = a;
                CUP$parser$result = new Symbol(1/*constraint*/,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).left,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right,
                                               RESULT);
            }
            ...
            case 1: // $START ::= constraint EOF
            {
                ...
                RESULT = start_val;
                CUP$parser$result = new Symbol(0/*$START*/,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 1)).left,
                                               ((Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 0)).right,
                                               RESULT);
            }
