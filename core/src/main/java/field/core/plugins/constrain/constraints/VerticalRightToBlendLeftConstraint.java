...
public
class VerticalRightToBlendLeftConstraint extends VerticalLeftToBlendLeftConstraint {
    ...
    ClLinearEquation createConstraint(VariablesForRect vLeft,
                                      ...
                                      float alpha) {
        try {
            return new ClLinearEquation(ClLinearExpression.Plus(new ClLinearExpression(vLeft.variableX),
                                                                new ClLinearExpression(vLeft.variableW)),
