...
class ClVariable extends ClAbstractVariable {
    ...
    public
    ClVariable(long number, String prefix, double value) {
        super(number, prefix);
        _value = value;
    }

    public
    ClVariable(long number, String prefix) {
        super(number, prefix);
        _value = 0.0;
    }
    ...
    public static
    void setVarMap(Hashtable<String, ClVariable> map) {
        _ourVarMap = map;
    }

    public static
    Hashtable<String, ClVariable> getVarMap() {
        return _ourVarMap;
    }
