...
public
class WindowSpaceBox {

    public static final VisualElementProperty<Boolean> isWindowSpace =
            new VisualElementProperty<Boolean>("isWindowSpace");
    private final GLComponentWindow window;

    public
    WindowSpaceBox(GLComponentWindow window) {
        this.window = window;
    }
