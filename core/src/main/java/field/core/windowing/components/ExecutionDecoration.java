...
class ExecutionDecoration {
    ...
    public
    ExecutionDecoration(iComponent component) {
    ...
    public
    boolean up(Event event) {
        if (decoration == Decoration.nothing) return false;
    ...
    void paintNow() {
...

        {
            ...
            in.setPointAttribute(iLinearGraphicsContext.fillColor_v,
                                 armed ? new Vector4(0.5, 0, 0, 0.25) : new Vector4(1, 1, 1, 0.15));
        ...
        }
        {
            ...
            in.setPointAttribute(iLinearGraphicsContext.strokeColor_v,
                                 armed ? new Vector4(0, 0, 0, 0) : new Vector4(0, 0, 0, 0.0));
            in.setPointAttribute(iLinearGraphicsContext.fillColor_v,
                                 armed ? new Vector4(0, 0, 0, 0.0) : new Vector4(0, 0, 0, 0.0));
            in.lineTo((float) (bounds.x + bounds.w + 1), (float) bounds.y);
            in.setPointAttribute(iLinearGraphicsContext.strokeColor_v,
                                 armed ? new Vector4(0, 0, 0, 0.5f) : new Vector4(0, 0, 0, 0.3));
            in.setPointAttribute(iLinearGraphicsContext.fillColor_v,
                                 armed ? new Vector4(0, 0, 0, 0.5f) : new Vector4(0, 0, 0, 0.3));
            in.lineTo((float) (bounds.x + bounds.w + 1), (float) (bounds.y + bounds.h));
            in.setPointAttribute(iLinearGraphicsContext.strokeColor_v,
    ...
    public
    boolean intersectsWithDecoration(Event event) {
        try {
            Rect b = component.getBounds();

            return event.x * decoration.d.d.x >= (downAt.x + 20f * decoration.d.d.x) * decoration.d.d.x
                   && event.y * decoration.d.d.y >= (downAt.y + 20f * decoration.d.d.y) * decoration.d.d.y;
