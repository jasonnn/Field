...
public
class ComponentDrawingUtils {

    public static
    void diagonalStripe(Rect bounds, DynamicLine line, Vector4 color, int pitch) {
        line.open();
    ...
    public static
    void drawRectangle(iDynamicMesh triangle,
                       DynamicLine line,
                       DynamicPointlist point,
                       float x,
                       float y,
                       float w,
                       float h,
    ...
    private static
    void drawLine(DynamicLine line, float sx, float sy, float mx, float my, float l1, float l2, Vector4 color) {
        if (l2 <= l1) return;
