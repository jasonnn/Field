...
public
class GlassComponent implements iComponent {
    ...
    public
    GlassComponent(RootComponent root, DragDuplicator duplicator) {
        this.root = root;
        this.duplicator = duplicator;
    }

    public
    void addMousePeer(iMousePeer mousePeer) {
        this.mousePeers.add(mousePeer);
    }

    public
    void addTransparentMousePeer(iMousePeer mousePeer) {
    ...
    public
    void removeMousePeer(iMousePeer mousePeer) {
