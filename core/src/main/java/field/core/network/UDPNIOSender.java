...
class UDPNIOSender {
    ...
    public
    UDPNIOSender(int port, String to) {
    ...
    public
    UDPNIOSender(int port, int local_port, String to) {
        this.channel = makeChannel(local_port);
        setup(channel, port, to);
    }

    public
    UDPNIOSender(DatagramChannel channel, int port, String to) {
    ...
    protected
    void setup(DatagramChannel channel, int port, String to) {
        try {
