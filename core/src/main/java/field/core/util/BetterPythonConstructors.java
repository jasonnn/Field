...
public
class BetterPythonConstructors implements ClassLoadedNotification {

    @Target(ElementType.TYPE)
    @Retention(RetentionPolicy.RUNTIME)
    public
    @interface SynthesizeFactory {
    }
            ...
            void update() {
                ...
                try {
                    ...
                    String doc = "Construct a"
                                 ...
                                 + Platform.getCanonicalName(loaded)
                                 + " using keyword arg style.\n\n Keys are:\n\n";
