...
public
class PythonCallableMap implements iCallable {
    ...
    public
    PyFunction register(String name, PyFunction f) {
    ...
    protected
    Callable newCallable(PyFunction f) {
        return PythonOverridden.callableForFunction(f,
    ...
    protected
    void doRegister(String name, Callable newCallable, Callable oldCallable) {
        known.put(name, newCallable);
    }

    public
    PyFunction register(PyFunction f) {
    ...
    public
    PyFunction registerUniq(PyFunction f) {
    ...
    public
    Collection<Object> gather(Object... a) {
        PythonInterface.getPythonInterface().setVariable("hooks", this);
    ...
    public
    Object invokeChained(Object... a) {
        PythonInterface.getPythonInterface().setVariable("hooks", this);

        Object[] aa = new Object[(a == null) ? 1 : (a.length + 1)];
        if (a != null) System.arraycopy(a, 0, aa, 1, a.length);
        aa[0] = Py.None;
    ...
    Object call(Object[] args) {
        if (args.length == 1) return register((PyFunction) args[0]);
        else return register((String) args[0], (PyFunction) args[1]);
    }

    public
    void merge(PythonCallableMap u) {
        if (u != null) this.known.putAll(u.known);
    }
    ...
    PythonCallableMap merge(IVisualElement from, VisualElementProperty<PythonCallableMap> parameter) {
        return new FastVisualElementOverridesPropertyCombiner<PythonCallableMap, PythonCallableMap>(false).getProperty(from,
                                                                                                                       ...
                                                                                                                       new iCombiner<PythonCallableMap, PythonCallableMap>() {
                                                                                                                           ...
                                                                                                                           @Override
                                                                                                                           public
                                                                                                                           PythonCallableMap unit() {
                                                                                                                               return new PythonCallableMap();
                                                                                                                           }

                                                                                                                           @Override
                                                                                                                           public
                                                                                                                           PythonCallableMap bind(PythonCallableMap t,
                                                                                                                                                  PythonCallableMap u) {
                                                                                                                               PythonCallableMap
                                                                                                                                       m =
                                                                                                                                       new PythonCallableMap();
                                                                                                                               m.merge(t);
                                                                                                                               m.merge(u);
                                                                                                                               return m;
                                                                                                                           }
