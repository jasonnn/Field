...
class FieldPyObjectAdaptor2 {
    ...
    void isExtensible(Class<? extends iExtensible> c) {
        ...
        // ---------------------------------------------------------------------
        {
            ...
            PyBuiltinMethodNarrow meth = new PyBuiltinMethodNarrow("__getattribute__", 1) {
                @Override
                public
                PyObject __call__(PyObject name) {
                    try {
        ...
        }
        {
            ...
            PyBuiltinMethodNarrow meth = new PyBuiltinMethodNarrow("__setattr__", 2) {
                @Override
                public
                PyObject __call__(PyObject name, PyObject to) {
                    try {
    ...
    protected
    FieldPyObjectAdaptor2 install(ExtensiblePyObjectAdapter ex) {
        ...
        PyBuiltinMethodNarrow meth = new PyBuiltinMethodNarrow("__ilshift__", 1) {
            @Override
            public
            PyObject __call__(PyObject composeWith) {
