...
public interface added_interface extends iAcceptor<field.core.dispatch.iVisualElement>, iFunction<GraphNodeSearching.VisitCode ,field.core.dispatch.iVisualElement >
	{
		public GraphNodeSearching.VisitCode added( final field.core.dispatch.iVisualElement p0);
	public iUpdateable updateable(final field.core.dispatch.iVisualElement p0);
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0);
}
...
public interface beginExecution_interface extends iAcceptor<field.core.dispatch.iVisualElement>, iFunction<GraphNodeSearching.VisitCode ,field.core.dispatch.iVisualElement >
	{
		public GraphNodeSearching.VisitCode beginExecution( final field.core.dispatch.iVisualElement p0);
	public iUpdateable updateable(final field.core.dispatch.iVisualElement p0);
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0);
}
...
public interface deleted_interface extends iAcceptor<field.core.dispatch.iVisualElement>, iFunction<GraphNodeSearching.VisitCode ,field.core.dispatch.iVisualElement >
	{
		public GraphNodeSearching.VisitCode deleted( final field.core.dispatch.iVisualElement p0);
	public iUpdateable updateable(final field.core.dispatch.iVisualElement p0);
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0);
}
...
public interface deleteProperty_interface extends iAcceptor<Object[]>, iFunction<GraphNodeSearching.VisitCode ,Object[] >
	{
		public GraphNodeSearching.VisitCode deleteProperty( final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.VisualElementProperty p1);
...
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.VisualElementProperty p1);
}
...
public interface endExecution_interface extends iAcceptor<field.core.dispatch.iVisualElement>, iFunction<GraphNodeSearching.VisitCode ,field.core.dispatch.iVisualElement >
	{
		public GraphNodeSearching.VisitCode endExecution( final field.core.dispatch.iVisualElement p0);
	public iUpdateable updateable(final field.core.dispatch.iVisualElement p0);
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0);
}
...
public interface getProperty_interface extends iAcceptor<Object[]>, iFunction<GraphNodeSearching.VisitCode ,Object[] >
	{
		public GraphNodeSearching.VisitCode getProperty( final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.VisualElementProperty p1, final field.core.dispatch.iVisualElementOverrides.Ref p2);
...
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.VisualElementProperty p1, final field.core.dispatch.iVisualElementOverrides.Ref p2);
}
...
public interface handleKeyboardEvent_interface extends iAcceptor<Object[]>, iFunction<GraphNodeSearching.VisitCode ,Object[] >
	{
		public GraphNodeSearching.VisitCode handleKeyboardEvent( final field.core.dispatch.iVisualElement p0, final org.eclipse.swt.widgets.Event p1);
	public iUpdateable updateable(final field.core.dispatch.iVisualElement p0, final org.eclipse.swt.widgets.Event p1);
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0, final org.eclipse.swt.widgets.Event p1);
}
...
public interface inspectablePropertiesFor_interface extends iAcceptor<Object[]>, iFunction<GraphNodeSearching.VisitCode ,Object[] >
	{
		public GraphNodeSearching.VisitCode inspectablePropertiesFor( final field.core.dispatch.iVisualElement p0, final java.util.List p1);
	public iUpdateable updateable(final field.core.dispatch.iVisualElement p0, final java.util.List p1);
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0, final java.util.List p1);
}
...
public interface isHit_interface extends iAcceptor<Object[]>, iFunction<GraphNodeSearching.VisitCode ,Object[] >
	{
		public GraphNodeSearching.VisitCode isHit( final field.core.dispatch.iVisualElement p0, final org.eclipse.swt.widgets.Event p1, final field.core.dispatch.iVisualElementOverrides.Ref p2);
...
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0, final org.eclipse.swt.widgets.Event p1, final field.core.dispatch.iVisualElementOverrides.Ref p2);
}
...
public interface menuItemsFor_interface extends iAcceptor<Object[]>, iFunction<GraphNodeSearching.VisitCode ,Object[] >
	{
		public GraphNodeSearching.VisitCode menuItemsFor( final field.core.dispatch.iVisualElement p0, final java.util.Map p1);
	public iUpdateable updateable(final field.core.dispatch.iVisualElement p0, final java.util.Map p1);
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0, final java.util.Map p1);
}
...
public interface paintNow_interface extends iAcceptor<Object[]>, iFunction<GraphNodeSearching.VisitCode ,Object[] >
	{
		public GraphNodeSearching.VisitCode paintNow( final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.Rect p1, final boolean p2);
...
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.Rect p1, final boolean p2);
}
...
public interface setProperty_interface extends iAcceptor<Object[]>, iFunction<GraphNodeSearching.VisitCode ,Object[] >
	{
		public GraphNodeSearching.VisitCode setProperty( final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.VisualElementProperty p1, final field.core.dispatch.iVisualElementOverrides.Ref p2);
	public iUpdateable updateable(final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.VisualElementProperty p1, final field.core.dispatch.iVisualElementOverrides.Ref p2);
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.VisualElementProperty p1, final field.core.dispatch.iVisualElementOverrides.Ref p2);
}
...
public interface shouldChangeFrame_interface extends iAcceptor<Object[]>, iFunction<GraphNodeSearching.VisitCode ,Object[] >
	{
		public GraphNodeSearching.VisitCode shouldChangeFrame( final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.Rect p1, final field.core.dispatch.iVisualElement.Rect p2, final boolean p3);
...
public iProvider<GraphNodeSearching.VisitCode> bind(final field.core.dispatch.iVisualElement p0, final field.core.dispatch.iVisualElement.Rect p1, final field.core.dispatch.iVisualElement.Rect p2, final boolean p3);
}
...
public iVisualElementOverrides_m(final iVisualElementOverrides x) {
		added = new added_interface()
		{
			...
			public GraphNodeSearching.VisitCode f(field.core.dispatch.iVisualElement p)
			{
...
return new iProvider(){public Object get(){return deleted(p0);}};}};
		...
		deleteProperty = new deleteProperty_interface()
		{
			...
			public GraphNodeSearching.VisitCode f(Object[] p)
			{
				return (GraphNodeSearching.VisitCode) f.f(p);
			}
