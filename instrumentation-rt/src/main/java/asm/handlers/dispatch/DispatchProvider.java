...
interface DispatchProvider {
    public
    Apply getTopologyForEntrance(Object root, Map<String, Object> parameters, Object[] args, String className);

    public
    Apply getTopologyForExit(Object root, Map<String, Object> parameters, Object[] args, String className);
